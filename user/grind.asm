...
go(int which_child)
{
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	30a98993          	addi	s3,s3,778 # 13f0 <malloc+0x124>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2f898993          	addi	s3,s3,760 # 13e8 <malloc+0x11c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	5d4a0a13          	addi	s4,s4,1492 # 16d0 <buf.0>
    ...
    if(what == 1){
     ...
     2a2:	3d258593          	addi	a1,a1,978 # 1670 <malloc+0x3a4>
     ...
     2c6:	3b650513          	addi	a0,a0,950 # 1678 <malloc+0x3ac>
     2ca:	00001097          	auipc	ra,0x1
     2ce:	f44080e7          	jalr	-188(ra) # 120e <printf>
        exit(1);
     2d2:	4505                	li	a0,1
     ...
     2e4:	12850513          	addi	a0,a0,296 # 1408 <malloc+0x13c>
     ...
     36c:	0c050513          	addi	a0,a0,192 # 1428 <malloc+0x15c>
     ...
     38e:	0ae50513          	addi	a0,a0,174 # 1438 <malloc+0x16c>
     ...
     3c6:	03650513          	addi	a0,a0,54 # 13f8 <malloc+0x12c>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	afc080e7          	jalr	-1284(ra) # ec6 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	07a50513          	addi	a0,a0,122 # 1450 <malloc+0x184>
     ...
     4b8:	00450513          	addi	a0,a0,4 # 14b8 <malloc+0x1ec>
     4bc:	00001097          	auipc	ra,0x1
     4c0:	d52080e7          	jalr	-686(ra) # 120e <printf>
        exit(1);
     4c4:	4505                	li	a0,1
     ...
     506:	fb650513          	addi	a0,a0,-74 # 14b8 <malloc+0x1ec>
     50a:	00001097          	auipc	ra,0x1
     50e:	d04080e7          	jalr	-764(ra) # 120e <printf>
        exit(1);
     512:	4505                	li	a0,1
     ...
     518:	94a080e7          	jalr	-1718(ra) # e5e <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.0+0xab>
     ...
     566:	f6e50513          	addi	a0,a0,-146 # 14d0 <malloc+0x204>
     ...
     592:	f0a50513          	addi	a0,a0,-246 # 1498 <malloc+0x1cc>
     ...
     5b4:	f0850513          	addi	a0,a0,-248 # 14b8 <malloc+0x1ec>
     5b8:	00001097          	auipc	ra,0x1
     5bc:	c56080e7          	jalr	-938(ra) # 120e <printf>
        exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	f1650513          	addi	a0,a0,-234 # 14e0 <malloc+0x214>
     5d2:	00001097          	auipc	ra,0x1
     5d6:	c3c080e7          	jalr	-964(ra) # 120e <printf>
        exit(1);
     5da:	4505                	li	a0,1
     ...
     61c:	ea050513          	addi	a0,a0,-352 # 14b8 <malloc+0x1ec>
     620:	00001097          	auipc	ra,0x1
     624:	bee080e7          	jalr	-1042(ra) # 120e <printf>
        exit(1);
     628:	4505                	li	a0,1
     ...
     678:	e8450513          	addi	a0,a0,-380 # 14f8 <malloc+0x22c>
     67c:	00001097          	auipc	ra,0x1
     680:	b92080e7          	jalr	-1134(ra) # 120e <printf>
        exit(1);
     684:	4505                	li	a0,1
     ...
     6a4:	e7058593          	addi	a1,a1,-400 # 1510 <malloc+0x244>
     ...
     6e0:	e3c50513          	addi	a0,a0,-452 # 1518 <malloc+0x24c>
     6e4:	00001097          	auipc	ra,0x1
     6e8:	b2a080e7          	jalr	-1238(ra) # 120e <printf>
     6ec:	b7f9                	j	6ba <go+0x642>
          printf("grind: pipe read failed\n");
     6ee:	00001517          	auipc	a0,0x1
     6f2:	e4a50513          	addi	a0,a0,-438 # 1538 <malloc+0x26c>
     6f6:	00001097          	auipc	ra,0x1
     6fa:	b18080e7          	jalr	-1256(ra) # 120e <printf>
     6fe:	bfd1                	j	6d2 <go+0x65a>
        printf("grind: fork failed\n");
     700:	00001517          	auipc	a0,0x1
     704:	db850513          	addi	a0,a0,-584 # 14b8 <malloc+0x1ec>
     708:	00001097          	auipc	ra,0x1
     70c:	b06080e7          	jalr	-1274(ra) # 120e <printf>
        exit(1);
     710:	4505                	li	a0,1
     ...
     7a6:	d1650513          	addi	a0,a0,-746 # 14b8 <malloc+0x1ec>
     7aa:	00001097          	auipc	ra,0x1
     7ae:	a64080e7          	jalr	-1436(ra) # 120e <printf>
        exit(1);
     7b2:	4505                	li	a0,1
     ...
     7c0:	d9c50513          	addi	a0,a0,-612 # 1558 <malloc+0x28c>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	6ea080e7          	jalr	1770(ra) # eae <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	d8850513          	addi	a0,a0,-632 # 1558 <malloc+0x28c>
     ...
     7ec:	d2858593          	addi	a1,a1,-728 # 1510 <malloc+0x244>
     ...
     832:	d2a50513          	addi	a0,a0,-726 # 1558 <malloc+0x28c>
     836:	00000097          	auipc	ra,0x0
     83a:	678080e7          	jalr	1656(ra) # eae <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	d2050513          	addi	a0,a0,-736 # 1560 <malloc+0x294>
     848:	00001097          	auipc	ra,0x1
     84c:	9c6080e7          	jalr	-1594(ra) # 120e <printf>
        exit(1);
     850:	4505                	li	a0,1
     ...
     85e:	d1e50513          	addi	a0,a0,-738 # 1578 <malloc+0x2ac>
     862:	00001097          	auipc	ra,0x1
     866:	9ac080e7          	jalr	-1620(ra) # 120e <printf>
        exit(1);
     86a:	4505                	li	a0,1
     ...
     878:	d1c50513          	addi	a0,a0,-740 # 1590 <malloc+0x2c4>
     87c:	00001097          	auipc	ra,0x1
     880:	992080e7          	jalr	-1646(ra) # 120e <printf>
        exit(1);
     884:	4505                	li	a0,1
     ...
     894:	d1850513          	addi	a0,a0,-744 # 15a8 <malloc+0x2dc>
     898:	00001097          	auipc	ra,0x1
     89c:	976080e7          	jalr	-1674(ra) # 120e <printf>
        exit(1);
     8a0:	4505                	li	a0,1
     ...
     8ae:	d2650513          	addi	a0,a0,-730 # 15d0 <malloc+0x304>
     8b2:	00001097          	auipc	ra,0x1
     8b6:	95c080e7          	jalr	-1700(ra) # 120e <printf>
        exit(1);
     8ba:	4505                	li	a0,1
     ...
     8c8:	c3458593          	addi	a1,a1,-972 # 14f8 <malloc+0x22c>
     8cc:	4509                	li	a0,2
     8ce:	00001097          	auipc	ra,0x1
     8d2:	912080e7          	jalr	-1774(ra) # 11e0 <fprintf>
        exit(1);
     8d6:	4505                	li	a0,1
     ...
     8e4:	c1858593          	addi	a1,a1,-1000 # 14f8 <malloc+0x22c>
     8e8:	4509                	li	a0,2
     8ea:	00001097          	auipc	ra,0x1
     8ee:	8f6080e7          	jalr	-1802(ra) # 11e0 <fprintf>
        exit(1);
     8f2:	4505                	li	a0,1
     ...
     940:	cbc58593          	addi	a1,a1,-836 # 15f8 <malloc+0x32c>
     944:	4509                	li	a0,2
     946:	00001097          	auipc	ra,0x1
     94a:	89a080e7          	jalr	-1894(ra) # 11e0 <fprintf>
          exit(1);
     94e:	4505                	li	a0,1
     ...
     9b4:	b0858593          	addi	a1,a1,-1272 # 14b8 <malloc+0x1ec>
     9b8:	4509                	li	a0,2
     9ba:	00001097          	auipc	ra,0x1
     9be:	826080e7          	jalr	-2010(ra) # 11e0 <fprintf>
        exit(3);
     9c2:	450d                	li	a0,3
     ...
     a00:	bfc58593          	addi	a1,a1,-1028 # 15f8 <malloc+0x32c>
     a04:	4509                	li	a0,2
     a06:	00000097          	auipc	ra,0x0
     a0a:	7da080e7          	jalr	2010(ra) # 11e0 <fprintf>
          exit(4);
     a0e:	4511                	li	a0,4
     ...
     a44:	bb858593          	addi	a1,a1,-1096 # 15f8 <malloc+0x32c>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	796080e7          	jalr	1942(ra) # 11e0 <fprintf>
          exit(5);
     a52:	4515                	li	a0,5
     ...
     a6c:	be078793          	addi	a5,a5,-1056 # 1648 <malloc+0x37c>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	bd450513          	addi	a0,a0,-1068 # 1650 <malloc+0x384>
     a84:	00000097          	auipc	ra,0x0
     a88:	412080e7          	jalr	1042(ra) # e96 <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	bcc58593          	addi	a1,a1,-1076 # 1658 <malloc+0x38c>
     a94:	4509                	li	a0,2
     a96:	00000097          	auipc	ra,0x0
     a9a:	74a080e7          	jalr	1866(ra) # 11e0 <fprintf>
        exit(6);
     a9e:	4519                	li	a0,6
     ...
     aac:	a1058593          	addi	a1,a1,-1520 # 14b8 <malloc+0x1ec>
     ab0:	4509                	li	a0,2
     ab2:	00000097          	auipc	ra,0x0
     ab6:	72e080e7          	jalr	1838(ra) # 11e0 <fprintf>
        exit(7);
     aba:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	9c850513          	addi	a0,a0,-1592 # 1498 <malloc+0x1cc>
     ad8:	00000097          	auipc	ra,0x0
     adc:	3d6080e7          	jalr	982(ra) # eae <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	96850513          	addi	a0,a0,-1688 # 1448 <malloc+0x17c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b18:	9a450513          	addi	a0,a0,-1628 # 14b8 <malloc+0x1ec>
     b1c:	00000097          	auipc	ra,0x0
     b20:	6f2080e7          	jalr	1778(ra) # 120e <printf>
    exit(1);
     b24:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b5a:	96250513          	addi	a0,a0,-1694 # 14b8 <malloc+0x1ec>
     b5e:	00000097          	auipc	ra,0x0
     b62:	6b0080e7          	jalr	1712(ra) # 120e <printf>
    exit(1);
     b66:	4505                	li	a0,1
...
0000000000000f16 <kthread_create>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f4c:	f36080e7          	jalr	-202(ra) # e7e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f7e:	72e50513          	addi	a0,a0,1838 # 16a8 <digits>
     f82:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    104a:	662b8b93          	addi	s7,s7,1634 # 16a8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    118a:	51a90913          	addi	s2,s2,1306 # 16a0 <malloc+0x3d4>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1252:	47a7b783          	ld	a5,1146(a5) # 16c8 <freep>
    ...
    1280:	00e6ea63          	bltu	a3,a4,1294 <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    129a:	02059813          	slli	a6,a1,0x20
    129e:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    12ae:	02061593          	slli	a1,a2,0x20
    12b2:	01c5d713          	srli	a4,a1,0x1c
  ...
  freep = p;
    ...
    12c2:	40f73523          	sd	a5,1034(a4) # 16c8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12f4:	3d853503          	ld	a0,984(a0) # 16c8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    131c:	3b090913          	addi	s2,s2,944 # 16c8 <freep>
  if(p == (char*)-1)
    1320:	5afd                	li	s5,-1
    1322:	a895                	j	1396 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    1324:	00000797          	auipc	a5,0x0
    1328:	79478793          	addi	a5,a5,1940 # 1ab8 <base>
    132c:	00000717          	auipc	a4,0x0
    1330:	38f73e23          	sd	a5,924(a4) # 16c8 <freep>
    ...
    133a:	b7e1                	j	1302 <malloc+0x36>
      if(p->s.size == nunits)
    133c:	02e48c63          	beq	s1,a4,1374 <malloc+0xa8>
        p->s.size -= nunits;
    1340:	4137073b          	subw	a4,a4,s3
    1344:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1346:	02071693          	slli	a3,a4,0x20
    134a:	01c6d713          	srli	a4,a3,0x1c
    134e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1350:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1354:	00000717          	auipc	a4,0x0
    1358:	36a73a23          	sd	a0,884(a4) # 16c8 <freep>
      return (void*)(p + 1);
    135c:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    1360:	70e2                	ld	ra,56(sp)
    1362:	7442                	ld	s0,48(sp)
    1364:	74a2                	ld	s1,40(sp)
    1366:	7902                	ld	s2,32(sp)
    1368:	69e2                	ld	s3,24(sp)
    ...
    1378:	bff1                	j	1354 <malloc+0x88>
  hp->s.size = nu;
    137a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    137e:	0541                	addi	a0,a0,16
    1380:	00000097          	auipc	ra,0x0
    1384:	ec4080e7          	jalr	-316(ra) # 1244 <free>
  return freep;
    1388:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    138c:	d971                	beqz	a0,1360 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    138e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1390:	4798                	lw	a4,8(a5)
    1392:	fa9775e3          	bgeu	a4,s1,133c <malloc+0x70>
    if(p == freep)
    1396:	00093703          	ld	a4,0(s2)
    139a:	853e                	mv	a0,a5
    139c:	fef719e3          	bne	a4,a5,138e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    13a0:	8552                	mv	a0,s4
    13a2:	00000097          	auipc	ra,0x0
    13a6:	b44080e7          	jalr	-1212(ra) # ee6 <sbrk>
  if(p == (char*)-1)
    13aa:	fd5518e3          	bne	a0,s5,137a <malloc+0xae>
        return 0;
    13ae:	4501                	li	a0,0
    13b0:	bf45                	j	1360 <malloc+0x94>
