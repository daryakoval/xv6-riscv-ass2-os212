...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	eea50513          	addi	a0,a0,-278 # 5f28 <malloc+0x41a>
      46:	00006097          	auipc	ra,0x6
      4a:	a0a080e7          	jalr	-1526(ra) # 5a50 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	44078793          	addi	a5,a5,1088 # 9498 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	b4868693          	addi	a3,a3,-1208 # bba8 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	ec850513          	addi	a0,a0,-312 # 5f48 <malloc+0x43a>
      88:	00006097          	auipc	ra,0x6
      8c:	9c8080e7          	jalr	-1592(ra) # 5a50 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	eb850513          	addi	a0,a0,-328 # 5f60 <malloc+0x452>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	eba50513          	addi	a0,a0,-326 # 5f80 <malloc+0x472>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	e8250513          	addi	a0,a0,-382 # 5f68 <malloc+0x45a>
      ee:	00006097          	auipc	ra,0x6
      f2:	962080e7          	jalr	-1694(ra) # 5a50 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	e8e50513          	addi	a0,a0,-370 # 5f90 <malloc+0x482>
     10a:	00006097          	auipc	ra,0x6
     10e:	946080e7          	jalr	-1722(ra) # 5a50 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	e8c50513          	addi	a0,a0,-372 # 5fb8 <malloc+0x4aa>
     134:	00005097          	auipc	ra,0x5
     138:	5bc080e7          	jalr	1468(ra) # 56f0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	e7850513          	addi	a0,a0,-392 # 5fb8 <malloc+0x4aa>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	e7458593          	addi	a1,a1,-396 # 5fc8 <malloc+0x4ba>
     15c:	00005097          	auipc	ra,0x5
     160:	564080e7          	jalr	1380(ra) # 56c0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	e5050513          	addi	a0,a0,-432 # 5fb8 <malloc+0x4aa>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	e5458593          	addi	a1,a1,-428 # 5fd0 <malloc+0x4c2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	e2450513          	addi	a0,a0,-476 # 5fb8 <malloc+0x4aa>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	e0e50513          	addi	a0,a0,-498 # 5fd8 <malloc+0x4ca>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	87e080e7          	jalr	-1922(ra) # 5a50 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	b4c50513          	addi	a0,a0,-1204 # 5dc8 <malloc+0x2ba>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b38a8a93          	addi	s5,s5,-1224 # 5dc8 <malloc+0x2ba>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	910a0a13          	addi	s4,s4,-1776 # bba8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	cee50513          	addi	a0,a0,-786 # 6000 <malloc+0x4f2>
     31a:	00005097          	auipc	ra,0x5
     31e:	736080e7          	jalr	1846(ra) # 5a50 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	cea50513          	addi	a0,a0,-790 # 6020 <malloc+0x512>
     33e:	00005097          	auipc	ra,0x5
     342:	712080e7          	jalr	1810(ra) # 5a50 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	cc6a0a13          	addi	s4,s4,-826 # 6038 <malloc+0x52a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	c2250513          	addi	a0,a0,-990 # 6040 <malloc+0x532>
     426:	00005097          	auipc	ra,0x5
     42a:	62a080e7          	jalr	1578(ra) # 5a50 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	c1c50513          	addi	a0,a0,-996 # 6058 <malloc+0x54a>
     444:	00005097          	auipc	ra,0x5
     448:	60c080e7          	jalr	1548(ra) # 5a50 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	c2e50513          	addi	a0,a0,-978 # 6088 <malloc+0x57a>
     462:	00005097          	auipc	ra,0x5
     466:	5ee080e7          	jalr	1518(ra) # 5a50 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	c4450513          	addi	a0,a0,-956 # 60b8 <malloc+0x5aa>
     47c:	00005097          	auipc	ra,0x5
     480:	5d4080e7          	jalr	1492(ra) # 5a50 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	c3650513          	addi	a0,a0,-970 # 60c8 <malloc+0x5ba>
     49a:	00005097          	auipc	ra,0x5
     49e:	5b6080e7          	jalr	1462(ra) # 5a50 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	c28a0a13          	addi	s4,s4,-984 # 60f8 <malloc+0x5ea>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	af8a8a93          	addi	s5,s5,-1288 # 5fd0 <malloc+0x4c2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	b8250513          	addi	a0,a0,-1150 # 6100 <malloc+0x5f2>
     586:	00005097          	auipc	ra,0x5
     58a:	4ca080e7          	jalr	1226(ra) # 5a50 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	b7c50513          	addi	a0,a0,-1156 # 6118 <malloc+0x60a>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	4ac080e7          	jalr	1196(ra) # 5a50 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	b0250513          	addi	a0,a0,-1278 # 60b8 <malloc+0x5aa>
     5be:	00005097          	auipc	ra,0x5
     5c2:	492080e7          	jalr	1170(ra) # 5a50 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	b7850513          	addi	a0,a0,-1160 # 6148 <malloc+0x63a>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	478080e7          	jalr	1144(ra) # 5a50 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	b7250513          	addi	a0,a0,-1166 # 6160 <malloc+0x652>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	45a080e7          	jalr	1114(ra) # 5a50 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	98458593          	addi	a1,a1,-1660 # 5fc8 <malloc+0x4ba>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	95850513          	addi	a0,a0,-1704 # 5fb8 <malloc+0x4aa>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	92c50513          	addi	a0,a0,-1748 # 5fb8 <malloc+0x4aa>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	91850513          	addi	a0,a0,-1768 # 5fb8 <malloc+0x4aa>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	b1258593          	addi	a1,a1,-1262 # 61f0 <malloc+0x6e2>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	89850513          	addi	a0,a0,-1896 # 5fb8 <malloc+0x4aa>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	a2c50513          	addi	a0,a0,-1492 # 6190 <malloc+0x682>
     76c:	00005097          	auipc	ra,0x5
     770:	2e4080e7          	jalr	740(ra) # 5a50 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	a3050513          	addi	a0,a0,-1488 # 61b0 <malloc+0x6a2>
     788:	00005097          	auipc	ra,0x5
     78c:	2c8080e7          	jalr	712(ra) # 5a50 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	a2c50513          	addi	a0,a0,-1492 # 61c0 <malloc+0x6b2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	2b4080e7          	jalr	692(ra) # 5a50 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	a3050513          	addi	a0,a0,-1488 # 61e0 <malloc+0x6d2>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	298080e7          	jalr	664(ra) # 5a50 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	9fc50513          	addi	a0,a0,-1540 # 61c0 <malloc+0x6b2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	284080e7          	jalr	644(ra) # 5a50 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	a1650513          	addi	a0,a0,-1514 # 61f8 <malloc+0x6ea>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	266080e7          	jalr	614(ra) # 5a50 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	a1850513          	addi	a0,a0,-1512 # 6218 <malloc+0x70a>
     808:	00005097          	auipc	ra,0x5
     80c:	248080e7          	jalr	584(ra) # 5a50 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	a0450513          	addi	a0,a0,-1532 # 6238 <malloc+0x72a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	a1498993          	addi	s3,s3,-1516 # 6260 <malloc+0x752>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	a44a8a93          	addi	s5,s5,-1468 # 6298 <malloc+0x78a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	99e50513          	addi	a0,a0,-1634 # 6238 <malloc+0x72a>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	2f458593          	addi	a1,a1,756 # bba8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	96250513          	addi	a0,a0,-1694 # 6238 <malloc+0x72a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	94050513          	addi	a0,a0,-1728 # 6240 <malloc+0x732>
     908:	00005097          	auipc	ra,0x5
     90c:	148080e7          	jalr	328(ra) # 5a50 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	95250513          	addi	a0,a0,-1710 # 6270 <malloc+0x762>
     926:	00005097          	auipc	ra,0x5
     92a:	12a080e7          	jalr	298(ra) # 5a50 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	96c50513          	addi	a0,a0,-1684 # 62a8 <malloc+0x79a>
     944:	00005097          	auipc	ra,0x5
     948:	10c080e7          	jalr	268(ra) # 5a50 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	97850513          	addi	a0,a0,-1672 # 62d0 <malloc+0x7c2>
     960:	00005097          	auipc	ra,0x5
     964:	0f0080e7          	jalr	240(ra) # 5a50 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	97c50513          	addi	a0,a0,-1668 # 62f0 <malloc+0x7e2>
     97c:	00005097          	auipc	ra,0x5
     980:	0d4080e7          	jalr	212(ra) # 5a50 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	97850513          	addi	a0,a0,-1672 # 6308 <malloc+0x7fa>
     998:	00005097          	auipc	ra,0x5
     99c:	0b8080e7          	jalr	184(ra) # 5a50 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	96650513          	addi	a0,a0,-1690 # 6328 <malloc+0x81a>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	1d290913          	addi	s2,s2,466 # bba8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	91450513          	addi	a0,a0,-1772 # 6328 <malloc+0x81a>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	18090913          	addi	s2,s2,384 # bba8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	8d450513          	addi	a0,a0,-1836 # 6330 <malloc+0x822>
     a64:	00005097          	auipc	ra,0x5
     a68:	fec080e7          	jalr	-20(ra) # 5a50 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	8d650513          	addi	a0,a0,-1834 # 6350 <malloc+0x842>
     a82:	00005097          	auipc	ra,0x5
     a86:	fce080e7          	jalr	-50(ra) # 5a50 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	8e250513          	addi	a0,a0,-1822 # 6378 <malloc+0x86a>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	fb2080e7          	jalr	-78(ra) # 5a50 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	86650513          	addi	a0,a0,-1946 # 6328 <malloc+0x81a>
     ...
     af2:	8aa50513          	addi	a0,a0,-1878 # 6398 <malloc+0x88a>
     af6:	00005097          	auipc	ra,0x5
     afa:	f5a080e7          	jalr	-166(ra) # 5a50 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	8b450513          	addi	a0,a0,-1868 # 63c0 <malloc+0x8b2>
     b14:	00005097          	auipc	ra,0x5
     b18:	f3c080e7          	jalr	-196(ra) # 5a50 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	8ae50513          	addi	a0,a0,-1874 # 63d8 <malloc+0x8ca>
     b32:	00005097          	auipc	ra,0x5
     b36:	f1e080e7          	jalr	-226(ra) # 5a50 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	8ba50513          	addi	a0,a0,-1862 # 6400 <malloc+0x8f2>
     b4e:	00005097          	auipc	ra,0x5
     b52:	f02080e7          	jalr	-254(ra) # 5a50 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	1e450513          	addi	a0,a0,484 # 5d58 <malloc+0x24a>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	8ac58593          	addi	a1,a1,-1876 # 6438 <malloc+0x92a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	1b050513          	addi	a0,a0,432 # 5d58 <malloc+0x24a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	19a50513          	addi	a0,a0,410 # 5d58 <malloc+0x24a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	18450513          	addi	a0,a0,388 # 5d58 <malloc+0x24a>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	89858593          	addi	a1,a1,-1896 # 6480 <malloc+0x972>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	fa458593          	addi	a1,a1,-92 # bba8 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	10850513          	addi	a0,a0,264 # 5d58 <malloc+0x24a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	7a850513          	addi	a0,a0,1960 # 6418 <malloc+0x90a>
     c78:	00005097          	auipc	ra,0x5
     c7c:	dd8080e7          	jalr	-552(ra) # 5a50 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	7b450513          	addi	a0,a0,1972 # 6440 <malloc+0x932>
     c94:	00005097          	auipc	ra,0x5
     c98:	dbc080e7          	jalr	-580(ra) # 5a50 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	7b850513          	addi	a0,a0,1976 # 6460 <malloc+0x952>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	da0080e7          	jalr	-608(ra) # 5a50 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	7c450513          	addi	a0,a0,1988 # 6488 <malloc+0x97a>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	d84080e7          	jalr	-636(ra) # 5a50 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	7c850513          	addi	a0,a0,1992 # 64a8 <malloc+0x99a>
     ce8:	00005097          	auipc	ra,0x5
     cec:	d68080e7          	jalr	-664(ra) # 5a50 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	7cc50513          	addi	a0,a0,1996 # 64c8 <malloc+0x9ba>
     d04:	00005097          	auipc	ra,0x5
     d08:	d4c080e7          	jalr	-692(ra) # 5a50 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	6d858593          	addi	a1,a1,1752 # 6438 <malloc+0x92a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	77058593          	addi	a1,a1,1904 # 64f0 <malloc+0x9e2>
     d88:	00005517          	auipc	a0,0x5
     d8c:	76050513          	addi	a0,a0,1888 # 64e8 <malloc+0x9da>
  ...
  unlink("lf1");
     ...
     da0:	74c50513          	addi	a0,a0,1868 # 64e8 <malloc+0x9da>
     da4:	00005097          	auipc	ra,0x5
     da8:	94c080e7          	jalr	-1716(ra) # 56f0 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	73a50513          	addi	a0,a0,1850 # 64e8 <malloc+0x9da>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	72c50513          	addi	a0,a0,1836 # 64f0 <malloc+0x9e2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	dcc58593          	addi	a1,a1,-564 # bba8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	6f458593          	addi	a1,a1,1780 # 64f0 <malloc+0x9e2>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	6de50513          	addi	a0,a0,1758 # 64f0 <malloc+0x9e2>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	8d6080e7          	jalr	-1834(ra) # 56f0 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	6c658593          	addi	a1,a1,1734 # 64e8 <malloc+0x9da>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	6c650513          	addi	a0,a0,1734 # 64f0 <malloc+0x9e2>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	6aa58593          	addi	a1,a1,1706 # 64e8 <malloc+0x9da>
     e46:	00005517          	auipc	a0,0x5
     e4a:	7b250513          	addi	a0,a0,1970 # 65f8 <malloc+0xaea>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	69050513          	addi	a0,a0,1680 # 64f8 <malloc+0x9ea>
     e70:	00005097          	auipc	ra,0x5
     e74:	be0080e7          	jalr	-1056(ra) # 5a50 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	68c50513          	addi	a0,a0,1676 # 6510 <malloc+0xa02>
     e8c:	00005097          	auipc	ra,0x5
     e90:	bc4080e7          	jalr	-1084(ra) # 5a50 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	68850513          	addi	a0,a0,1672 # 6528 <malloc+0xa1a>
     ea8:	00005097          	auipc	ra,0x5
     eac:	ba8080e7          	jalr	-1112(ra) # 5a50 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	68c50513          	addi	a0,a0,1676 # 6548 <malloc+0xa3a>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	b8c080e7          	jalr	-1140(ra) # 5a50 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	6a050513          	addi	a0,a0,1696 # 6578 <malloc+0xa6a>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	b70080e7          	jalr	-1168(ra) # 5a50 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	69c50513          	addi	a0,a0,1692 # 6590 <malloc+0xa82>
     efc:	00005097          	auipc	ra,0x5
     f00:	b54080e7          	jalr	-1196(ra) # 5a50 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	69850513          	addi	a0,a0,1688 # 65a8 <malloc+0xa9a>
     f18:	00005097          	auipc	ra,0x5
     f1c:	b38080e7          	jalr	-1224(ra) # 5a50 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	6a450513          	addi	a0,a0,1700 # 65d0 <malloc+0xac2>
     f34:	00005097          	auipc	ra,0x5
     f38:	b1c080e7          	jalr	-1252(ra) # 5a50 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	6b850513          	addi	a0,a0,1720 # 6600 <malloc+0xaf2>
     f50:	00005097          	auipc	ra,0x5
     f54:	b00080e7          	jalr	-1280(ra) # 5a50 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	672a0a13          	addi	s4,s4,1650 # 6620 <malloc+0xb12>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	62050513          	addi	a0,a0,1568 # 6620 <malloc+0xb12>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	5b850513          	addi	a0,a0,1464 # 6628 <malloc+0xb1a>
    1078:	00005097          	auipc	ra,0x5
    107c:	9d8080e7          	jalr	-1576(ra) # 5a50 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	5b850513          	addi	a0,a0,1464 # 6648 <malloc+0xb3a>
    1098:	00005097          	auipc	ra,0x5
    109c:	9b8080e7          	jalr	-1608(ra) # 5a50 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	5bc50513          	addi	a0,a0,1468 # 6668 <malloc+0xb5a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	99c080e7          	jalr	-1636(ra) # 5a50 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	5aa98993          	addi	s3,s3,1450 # 6688 <malloc+0xb7a>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	57e50513          	addi	a0,a0,1406 # 6698 <malloc+0xb8a>
    1122:	00005097          	auipc	ra,0x5
    1126:	92e080e7          	jalr	-1746(ra) # 5a50 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	2364b483          	ld	s1,566(s1) # 8378 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x7a8>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	dda98993          	addi	s3,s3,-550 # 5f60 <malloc+0x452>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	65878793          	addi	a5,a5,1624 # 7868 <malloc+0x1d5a>
  ...
  if(pid == 0){
    ...
    124a:	24a78793          	addi	a5,a5,586 # 8490 <big.0>
    124e:	00008697          	auipc	a3,0x8
    1252:	24268693          	addi	a3,a3,578 # 9490 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    1268:	22078623          	sb	zero,556(a5) # 9490 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	d0c78793          	addi	a5,a5,-756 # 7f78 <malloc+0x246a>
    ...
    1294:	cd050513          	addi	a0,a0,-816 # 5f60 <malloc+0x452>
    ...
    12ac:	49850513          	addi	a0,a0,1176 # 6740 <malloc+0xc32>
    12b0:	00004097          	auipc	ra,0x4
    12b4:	7a0080e7          	jalr	1952(ra) # 5a50 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	3f050513          	addi	a0,a0,1008 # 66b8 <malloc+0xbaa>
    12d0:	00004097          	auipc	ra,0x4
    12d4:	780080e7          	jalr	1920(ra) # 5a50 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	3f050513          	addi	a0,a0,1008 # 66d8 <malloc+0xbca>
    12f0:	00004097          	auipc	ra,0x4
    12f4:	760080e7          	jalr	1888(ra) # 5a50 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	3ee50513          	addi	a0,a0,1006 # 66f8 <malloc+0xbea>
    1312:	00004097          	auipc	ra,0x4
    1316:	73e080e7          	jalr	1854(ra) # 5a50 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	3f650513          	addi	a0,a0,1014 # 6720 <malloc+0xc12>
    1332:	00004097          	auipc	ra,0x4
    1336:	71e080e7          	jalr	1822(ra) # 5a50 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	85c50513          	addi	a0,a0,-1956 # 6ba0 <malloc+0x1092>
    134c:	00004097          	auipc	ra,0x4
    1350:	704080e7          	jalr	1796(ra) # 5a50 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	3da50513          	addi	a0,a0,986 # 6768 <malloc+0xc5a>
    1396:	00004097          	auipc	ra,0x4
    139a:	6ba080e7          	jalr	1722(ra) # 5a50 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	bf850513          	addi	a0,a0,-1032 # 5fb8 <malloc+0x4aa>
  ...
  if(pid == 0){
    ...
    13ee:	bcea0a13          	addi	s4,s4,-1074 # 5fb8 <malloc+0x4aa>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	3d6a8a93          	addi	s5,s5,982 # 67c8 <malloc+0xcba>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	33650513          	addi	a0,a0,822 # 6798 <malloc+0xc8a>
    146a:	00004097          	auipc	ra,0x4
    146e:	5e6080e7          	jalr	1510(ra) # 5a50 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	33250513          	addi	a0,a0,818 # 67b0 <malloc+0xca2>
    1486:	00004097          	auipc	ra,0x4
    148a:	5ca080e7          	jalr	1482(ra) # 5a50 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	33c50513          	addi	a0,a0,828 # 67d8 <malloc+0xcca>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	5ac080e7          	jalr	1452(ra) # 5a50 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	afea0a13          	addi	s4,s4,-1282 # 5fb8 <malloc+0x4aa>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	336a8a93          	addi	s5,s5,822 # 67f8 <malloc+0xcea>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	aac50513          	addi	a0,a0,-1364 # 5fb8 <malloc+0x4aa>
  ...
  exit(xstatus);
    ...
    152e:	28650513          	addi	a0,a0,646 # 67b0 <malloc+0xca2>
    1532:	00004097          	auipc	ra,0x4
    1536:	51e080e7          	jalr	1310(ra) # 5a50 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	2b850513          	addi	a0,a0,696 # 6800 <malloc+0xcf2>
    1550:	00004097          	auipc	ra,0x4
    1554:	500080e7          	jalr	1280(ra) # 5a50 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	9f078793          	addi	a5,a5,-1552 # 5f60 <malloc+0x452>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	2a478793          	addi	a5,a5,676 # 6820 <malloc+0xd12>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	29c50513          	addi	a0,a0,668 # 6828 <malloc+0xd1a>
  ...
  if(pid == 0) {
    ...
    15be:	26e50513          	addi	a0,a0,622 # 6828 <malloc+0xd1a>
    ...
    15da:	27250513          	addi	a0,a0,626 # 6848 <malloc+0xd3a>
    15de:	00004097          	auipc	ra,0x4
    15e2:	472080e7          	jalr	1138(ra) # 5a50 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	1a650513          	addi	a0,a0,422 # 6798 <malloc+0xc8a>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	456080e7          	jalr	1110(ra) # 5a50 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	22250513          	addi	a0,a0,546 # 6830 <malloc+0xd22>
    1616:	00004097          	auipc	ra,0x4
    161a:	43a080e7          	jalr	1082(ra) # 5a50 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	93450513          	addi	a0,a0,-1740 # 5f60 <malloc+0x452>
  ...
  if(xstatus != 0)
    ...
    1664:	1f850513          	addi	a0,a0,504 # 6858 <malloc+0xd4a>
    1668:	00004097          	auipc	ra,0x4
    166c:	3e8080e7          	jalr	1000(ra) # 5a50 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	1f450513          	addi	a0,a0,500 # 6870 <malloc+0xd62>
    1684:	00004097          	auipc	ra,0x4
    1688:	3cc080e7          	jalr	972(ra) # 5a50 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	19850513          	addi	a0,a0,408 # 6828 <malloc+0xd1a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	c3650513          	addi	a0,a0,-970 # 62f0 <malloc+0x7e2>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	38e080e7          	jalr	910(ra) # 5a50 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	0da50513          	addi	a0,a0,218 # 67b0 <malloc+0xca2>
    16de:	00004097          	auipc	ra,0x4
    16e2:	372080e7          	jalr	882(ra) # 5a50 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	13850513          	addi	a0,a0,312 # 6828 <malloc+0xd1a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	16e50513          	addi	a0,a0,366 # 6888 <malloc+0xd7a>
    1722:	00004097          	auipc	ra,0x4
    1726:	32e080e7          	jalr	814(ra) # 5a50 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	422a8a93          	addi	s5,s5,1058 # bba8 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	40470713          	addi	a4,a4,1028 # bba8 <buf>
    ...
    17e0:	0c450513          	addi	a0,a0,196 # 68a0 <malloc+0xd92>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	26c080e7          	jalr	620(ra) # 5a50 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	3a6b0b13          	addi	s6,s6,934 # bba8 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	05650513          	addi	a0,a0,86 # 68b8 <malloc+0xdaa>
    186a:	00004097          	auipc	ra,0x4
    186e:	1e6080e7          	jalr	486(ra) # 5a50 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	05250513          	addi	a0,a0,82 # 68d0 <malloc+0xdc2>
    1886:	00004097          	auipc	ra,0x4
    188a:	1ca080e7          	jalr	458(ra) # 5a50 <printf>
}
    ...
    18b4:	03850513          	addi	a0,a0,56 # 68e8 <malloc+0xdda>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	198080e7          	jalr	408(ra) # 5a50 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	01850513          	addi	a0,a0,24 # 6908 <malloc+0xdfa>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	158080e7          	jalr	344(ra) # 5a50 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	e3650513          	addi	a0,a0,-458 # 6798 <malloc+0xc8a>
    196a:	00004097          	auipc	ra,0x4
    196e:	0e6080e7          	jalr	230(ra) # 5a50 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	fa250513          	addi	a0,a0,-94 # 6920 <malloc+0xe12>
    1986:	00004097          	auipc	ra,0x4
    198a:	0ca080e7          	jalr	202(ra) # 5a50 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	f9e50513          	addi	a0,a0,-98 # 6938 <malloc+0xe2a>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	0ae080e7          	jalr	174(ra) # 5a50 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	d8650513          	addi	a0,a0,-634 # 6798 <malloc+0xc8a>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	036080e7          	jalr	54(ra) # 5a50 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	d6250513          	addi	a0,a0,-670 # 6798 <malloc+0xc8a>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	012080e7          	jalr	18(ra) # 5a50 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	ea850513          	addi	a0,a0,-344 # 6958 <malloc+0xe4a>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	f98080e7          	jalr	-104(ra) # 5a50 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	bde080e7          	jalr	-1058(ra) # 56a0 <exit>
{
    ...
    1b0c:	e6050513          	addi	a0,a0,-416 # 6968 <malloc+0xe5a>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	f40080e7          	jalr	-192(ra) # 5a50 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	04a50513          	addi	a0,a0,74 # 6ba0 <malloc+0x1092>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	ef2080e7          	jalr	-270(ra) # 5a50 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	fac50513          	addi	a0,a0,-84 # 6ba0 <malloc+0x1092>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	e54080e7          	jalr	-428(ra) # 5a50 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	c1050513          	addi	a0,a0,-1008 # 6830 <malloc+0xd22>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	e28080e7          	jalr	-472(ra) # 5a50 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	cf650513          	addi	a0,a0,-778 # 6988 <malloc+0xe7a>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	db6080e7          	jalr	-586(ra) # 5a50 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	cda50513          	addi	a0,a0,-806 # 69a0 <malloc+0xe92>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	d82080e7          	jalr	-638(ra) # 5a50 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	c9c50513          	addi	a0,a0,-868 # 69c8 <malloc+0xeba>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	d1c080e7          	jalr	-740(ra) # 5a50 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	20450513          	addi	a0,a0,516 # 5fd0 <malloc+0x4c2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	1c8a8a93          	addi	s5,s5,456 # 5fd0 <malloc+0x4c2>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	be0b8b93          	addi	s7,s7,-1056 # 69f0 <malloc+0xee2>
    1e18:	a825                	j	1e50 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	97c50513          	addi	a0,a0,-1668 # 6798 <malloc+0xc8a>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	c2c080e7          	jalr	-980(ra) # 5a50 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	c9650513          	addi	a0,a0,-874 # 6ba0 <malloc+0x1092>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	b3e080e7          	jalr	-1218(ra) # 5a50 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	c62b0b13          	addi	s6,s6,-926 # bba8 <buf>
    ...
    1fbe:	a3e50513          	addi	a0,a0,-1474 # 69f8 <malloc+0xeea>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	a8e080e7          	jalr	-1394(ra) # 5a50 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	04650513          	addi	a0,a0,70 # 6020 <malloc+0x512>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	a6e080e7          	jalr	-1426(ra) # 5a50 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	a0050513          	addi	a0,a0,-1536 # 6a28 <malloc+0xf1a>
    2030:	00004097          	auipc	ra,0x4
    2034:	a20080e7          	jalr	-1504(ra) # 5a50 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	98650513          	addi	a0,a0,-1658 # 6a10 <malloc+0xf02>
    2092:	00004097          	auipc	ra,0x4
    2096:	9be080e7          	jalr	-1602(ra) # 5a50 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	9aa50513          	addi	a0,a0,-1622 # 6a50 <malloc+0xf42>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	9a2080e7          	jalr	-1630(ra) # 5a50 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	9a650513          	addi	a0,a0,-1626 # 6a68 <malloc+0xf5a>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	986080e7          	jalr	-1658(ra) # 5a50 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x7a8>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e8c8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	65650513          	addi	a0,a0,1622 # 6798 <malloc+0xc8a>
    214a:	00004097          	auipc	ra,0x4
    214e:	906080e7          	jalr	-1786(ra) # 5a50 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	91c50513          	addi	a0,a0,-1764 # 6a80 <malloc+0xf72>
    216c:	00004097          	auipc	ra,0x4
    2170:	8e4080e7          	jalr	-1820(ra) # 5a50 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	90c50513          	addi	a0,a0,-1780 # 6aa0 <malloc+0xf92>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	8da50513          	addi	a0,a0,-1830 # 6aa0 <malloc+0xf92>
  ...
  close(fd);
    ...
    21f0:	1a478793          	addi	a5,a5,420 # 8390 <args.1>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	29468693          	addi	a3,a3,660 # 8488 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    21fc:	00005717          	auipc	a4,0x5
    2200:	8b470713          	addi	a4,a4,-1868 # 6ab0 <malloc+0xfa2>
    ...
    2254:	94050513          	addi	a0,a0,-1728 # 6b90 <malloc+0x1082>
    2258:	00003097          	auipc	ra,0x3
    225c:	7f8080e7          	jalr	2040(ra) # 5a50 <printf>
    exit(1);
    2260:	4505                	li	a0,1
    ...
    2278:	93c50513          	addi	a0,a0,-1732 # 6bb0 <malloc+0x10a2>
    227c:	00003097          	auipc	ra,0x3
    2280:	7d4080e7          	jalr	2004(ra) # 5a50 <printf>
    exit(1);
    2284:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22cc:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0448>
    22d0:	85a6                	mv	a1,s1
    22d2:	00005517          	auipc	a0,0x5
    22d6:	8fe50513          	addi	a0,a0,-1794 # 6bd0 <malloc+0x10c2>
    22da:	00003097          	auipc	ra,0x3
    22de:	776080e7          	jalr	1910(ra) # 5a50 <printf>
    exit(1);
    22e2:	4505                	li	a0,1
    ...
    22f2:	4aa50513          	addi	a0,a0,1194 # 6798 <malloc+0xc8a>
    22f6:	00003097          	auipc	ra,0x3
    22fa:	75a080e7          	jalr	1882(ra) # 5a50 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	4e078793          	addi	a5,a5,1248 # 7868 <malloc+0x1d5a>
  ...
  if(ret != -1){
    ...
    23ce:	82e50513          	addi	a0,a0,-2002 # 6bf8 <malloc+0x10ea>
    23d2:	00003097          	auipc	ra,0x3
    23d6:	67e080e7          	jalr	1662(ra) # 5a50 <printf>
    exit(1);
    23da:	4505                	li	a0,1
    ...
    23ec:	2d050513          	addi	a0,a0,720 # 66b8 <malloc+0xbaa>
    23f0:	00003097          	auipc	ra,0x3
    23f4:	660080e7          	jalr	1632(ra) # 5a50 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    240a:	2d250513          	addi	a0,a0,722 # 66d8 <malloc+0xbca>
    240e:	00003097          	auipc	ra,0x3
    2412:	642080e7          	jalr	1602(ra) # 5a50 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    242a:	2d250513          	addi	a0,a0,722 # 66f8 <malloc+0xbea>
    242e:	00003097          	auipc	ra,0x3
    2432:	622080e7          	jalr	1570(ra) # 5a50 <printf>
    exit(1);
    2436:	4505                	li	a0,1
    ...
    2448:	2dc50513          	addi	a0,a0,732 # 6720 <malloc+0xc12>
    244c:	00003097          	auipc	ra,0x3
    2450:	604080e7          	jalr	1540(ra) # 5a50 <printf>
    exit(1);
    2454:	4505                	li	a0,1
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	7e050513          	addi	a0,a0,2016 # 5c70 <malloc+0x162>
  ...
  if(n >= 0){
    ...
    24c6:	78e50513          	addi	a0,a0,1934 # 6c50 <malloc+0x1142>
    24ca:	00003097          	auipc	ra,0x3
    24ce:	586080e7          	jalr	1414(ra) # 5a50 <printf>
    exit(1);
    24d2:	4505                	li	a0,1
    ...
    24e0:	72450513          	addi	a0,a0,1828 # 6c00 <malloc+0x10f2>
    24e4:	00003097          	auipc	ra,0x3
    24e8:	56c080e7          	jalr	1388(ra) # 5a50 <printf>
    exit(1);
    24ec:	4505                	li	a0,1
    ...
    24fa:	72250513          	addi	a0,a0,1826 # 6c18 <malloc+0x110a>
    24fe:	00003097          	auipc	ra,0x3
    2502:	552080e7          	jalr	1362(ra) # 5a50 <printf>
    exit(1);
    2506:	4505                	li	a0,1
    ...
    2514:	72850513          	addi	a0,a0,1832 # 6c38 <malloc+0x112a>
    2518:	00003097          	auipc	ra,0x3
    251c:	538080e7          	jalr	1336(ra) # 5a50 <printf>
    exit(1);
    2520:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2538:	73c50513          	addi	a0,a0,1852 # 5c70 <malloc+0x162>
    253c:	00003097          	auipc	ra,0x3
    2540:	1b4080e7          	jalr	436(ra) # 56f0 <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	bb250513          	addi	a0,a0,-1102 # 60f8 <malloc+0x5ea>
  ...
  if(n >= 0){
    ...
    2574:	71050513          	addi	a0,a0,1808 # 6c80 <malloc+0x1172>
    2578:	00003097          	auipc	ra,0x3
    257c:	4d8080e7          	jalr	1240(ra) # 5a50 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	6ae50513          	addi	a0,a0,1710 # 6c38 <malloc+0x112a>
    2592:	00003097          	auipc	ra,0x3
    2596:	4be080e7          	jalr	1214(ra) # 5a50 <printf>
    exit(1);
    259a:	4505                	li	a0,1
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    25f4:	6705                	lui	a4,0x1
      *b = 99;
    25f6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1448>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    260e:	69e50513          	addi	a0,a0,1694 # 6ca8 <malloc+0x119a>
    2612:	00003097          	auipc	ra,0x3
    2616:	43e080e7          	jalr	1086(ra) # 5a50 <printf>
    exit(1);
    261a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2660:	66c50513          	addi	a0,a0,1644 # 6cc8 <malloc+0x11ba>
    2664:	00003097          	auipc	ra,0x3
    2668:	3ec080e7          	jalr	1004(ra) # 5a50 <printf>
    exit(1);
    266c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    26c4:	66850513          	addi	a0,a0,1640 # 6d28 <malloc+0x121a>
    26c8:	00003097          	auipc	ra,0x3
    26cc:	388080e7          	jalr	904(ra) # 5a50 <printf>
    exit(1);
    26d0:	4505                	li	a0,1
    ...
    26e4:	60850513          	addi	a0,a0,1544 # 6ce8 <malloc+0x11da>
    26e8:	00003097          	auipc	ra,0x3
    26ec:	368080e7          	jalr	872(ra) # 5a50 <printf>
      exit(1);
    26f0:	4505                	li	a0,1
    ...
    2700:	60c50513          	addi	a0,a0,1548 # 6d08 <malloc+0x11fa>
    2704:	00003097          	auipc	ra,0x3
    2708:	34c080e7          	jalr	844(ra) # 5a50 <printf>
    exit(1);
    270c:	4505                	li	a0,1
...
000000000000273c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    279e:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1447>
  a = sbrk(0);
    27a2:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2802:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1447>
  ...
  if(c != a){
    ...
    284a:	50250513          	addi	a0,a0,1282 # 6d48 <malloc+0x123a>
    284e:	00003097          	auipc	ra,0x3
    2852:	202080e7          	jalr	514(ra) # 5a50 <printf>
    exit(1);
    2856:	4505                	li	a0,1
    ...
    2866:	52e50513          	addi	a0,a0,1326 # 6d90 <malloc+0x1282>
    286a:	00003097          	auipc	ra,0x3
    286e:	1e6080e7          	jalr	486(ra) # 5a50 <printf>
    exit(1);
    2872:	4505                	li	a0,1
    ...
    2886:	52e50513          	addi	a0,a0,1326 # 6db0 <malloc+0x12a2>
    288a:	00003097          	auipc	ra,0x3
    288e:	1c6080e7          	jalr	454(ra) # 5a50 <printf>
    exit(1);
    2892:	4505                	li	a0,1
    ...
    28a6:	54e50513          	addi	a0,a0,1358 # 6df0 <malloc+0x12e2>
    28aa:	00003097          	auipc	ra,0x3
    28ae:	1a6080e7          	jalr	422(ra) # 5a50 <printf>
    exit(1);
    28b2:	4505                	li	a0,1
    ...
    28c2:	56250513          	addi	a0,a0,1378 # 6e20 <malloc+0x1312>
    28c6:	00003097          	auipc	ra,0x3
    28ca:	18a080e7          	jalr	394(ra) # 5a50 <printf>
    exit(1);
    28ce:	4505                	li	a0,1
    ...
    28e2:	57a50513          	addi	a0,a0,1402 # 6e58 <malloc+0x134a>
    28e6:	00003097          	auipc	ra,0x3
    28ea:	16a080e7          	jalr	362(ra) # 5a50 <printf>
    exit(1);
    28ee:	4505                	li	a0,1
...
00000000000028f8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    291c:	56850513          	addi	a0,a0,1384 # 6e80 <malloc+0x1372>
    2920:	00003097          	auipc	ra,0x3
    2924:	dc0080e7          	jalr	-576(ra) # 56e0 <open>
    2928:	84aa                	mv	s1,a0
  unlink("sbrk");
    292a:	00004517          	auipc	a0,0x4
    292e:	55650513          	addi	a0,a0,1366 # 6e80 <malloc+0x1372>
  ...
  if(pipe((int *) a) != 0){
    ...
    2982:	50a50513          	addi	a0,a0,1290 # 6e88 <malloc+0x137a>
    2986:	00003097          	auipc	ra,0x3
    298a:	0ca080e7          	jalr	202(ra) # 5a50 <printf>
    exit(1);
    298e:	4505                	li	a0,1
    ...
    299e:	50650513          	addi	a0,a0,1286 # 6ea0 <malloc+0x1392>
    29a2:	00003097          	auipc	ra,0x3
    29a6:	0ae080e7          	jalr	174(ra) # 5a50 <printf>
    exit(1);
    29aa:	4505                	li	a0,1
    ...
    29ba:	eea50513          	addi	a0,a0,-278 # 68a0 <malloc+0xd92>
    29be:	00003097          	auipc	ra,0x3
    29c2:	092080e7          	jalr	146(ra) # 5a50 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
...
00000000000029d0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29e4:	4d850513          	addi	a0,a0,1240 # 6eb8 <malloc+0x13aa>
  ...
  close(fd);
    ...
    2a2c:	d8850513          	addi	a0,a0,-632 # 67b0 <malloc+0xca2>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	020080e7          	jalr	32(ra) # 5a50 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
...
0000000000002a42 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2a7a:	12a50513          	addi	a0,a0,298 # 6ba0 <malloc+0x1092>
    2a7e:	00003097          	auipc	ra,0x3
    2a82:	fd2080e7          	jalr	-46(ra) # 5a50 <printf>
    exit(1);
    2a86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2ad0:	0d450513          	addi	a0,a0,212 # 6ba0 <malloc+0x1092>
    2ad4:	00003097          	auipc	ra,0x3
    2ad8:	f7c080e7          	jalr	-132(ra) # 5a50 <printf>
    exit(1);
    2adc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b30:	07450513          	addi	a0,a0,116 # 6ba0 <malloc+0x1092>
    2b34:	00003097          	auipc	ra,0x3
    2b38:	f1c080e7          	jalr	-228(ra) # 5a50 <printf>
    exit(1);
    2b3c:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2b9c:	00850513          	addi	a0,a0,8 # 6ba0 <malloc+0x1092>
    2ba0:	00003097          	auipc	ra,0x3
    2ba4:	eb0080e7          	jalr	-336(ra) # 5a50 <printf>
      exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bf0:	37450513          	addi	a0,a0,884 # 5f60 <malloc+0x452>
    2bf4:	faa43c23          	sd	a0,-72(s0)
    2bf8:	00003797          	auipc	a5,0x3
    2bfc:	3d878793          	addi	a5,a5,984 # 5fd0 <malloc+0x4c2>
...
0000000000002c1e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c2e:	46650513          	addi	a0,a0,1126 # 7090 <malloc+0x1582>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c40:	2ac50513          	addi	a0,a0,684 # 6ee8 <malloc+0x13da>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c56:	2ee50513          	addi	a0,a0,750 # 6f40 <malloc+0x1432>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2c74:	34850513          	addi	a0,a0,840 # 6fb8 <malloc+0x14aa>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2c90:	39c50513          	addi	a0,a0,924 # 7028 <malloc+0x151a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2ca2:	3e250513          	addi	a0,a0,994 # 7080 <malloc+0x1572>
  ...
  unlink("12345678901234");
    ...
    2d20:	1a450513          	addi	a0,a0,420 # 6ec0 <malloc+0x13b2>
    2d24:	00003097          	auipc	ra,0x3
    2d28:	d2c080e7          	jalr	-724(ra) # 5a50 <printf>
    exit(1);
    2d2c:	4505                	li	a0,1
    ...
    2d3c:	1d050513          	addi	a0,a0,464 # 6f08 <malloc+0x13fa>
    2d40:	00003097          	auipc	ra,0x3
    2d44:	d10080e7          	jalr	-752(ra) # 5a50 <printf>
    exit(1);
    2d48:	4505                	li	a0,1
    ...
    2d58:	21c50513          	addi	a0,a0,540 # 6f70 <malloc+0x1462>
    2d5c:	00003097          	auipc	ra,0x3
    2d60:	cf4080e7          	jalr	-780(ra) # 5a50 <printf>
    exit(1);
    2d64:	4505                	li	a0,1
    ...
    2d74:	27850513          	addi	a0,a0,632 # 6fe8 <malloc+0x14da>
    2d78:	00003097          	auipc	ra,0x3
    2d7c:	cd8080e7          	jalr	-808(ra) # 5a50 <printf>
    exit(1);
    2d80:	4505                	li	a0,1
    ...
    2d90:	2bc50513          	addi	a0,a0,700 # 7048 <malloc+0x153a>
    2d94:	00003097          	auipc	ra,0x3
    2d98:	cbc080e7          	jalr	-836(ra) # 5a50 <printf>
    exit(1);
    2d9c:	4505                	li	a0,1
    ...
    2dac:	2f850513          	addi	a0,a0,760 # 70a0 <malloc+0x1592>
    2db0:	00003097          	auipc	ra,0x3
    2db4:	ca0080e7          	jalr	-864(ra) # 5a50 <printf>
    exit(1);
    2db8:	4505                	li	a0,1
...
0000000000002dc2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dd2:	30a50513          	addi	a0,a0,778 # 70d8 <malloc+0x15ca>
  ...
  if(chdir("iputdir") < 0){
    ...
    2de6:	2f650513          	addi	a0,a0,758 # 70d8 <malloc+0x15ca>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2dfa:	32250513          	addi	a0,a0,802 # 7118 <malloc+0x160a>
  ...
  if(chdir("/") < 0){
    ...
    2e0e:	33e50513          	addi	a0,a0,830 # 7148 <malloc+0x163a>
    ...
    2e2e:	2b650513          	addi	a0,a0,694 # 70e0 <malloc+0x15d2>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	c1e080e7          	jalr	-994(ra) # 5a50 <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
    ...
    2e4a:	2b250513          	addi	a0,a0,690 # 70f8 <malloc+0x15ea>
    2e4e:	00003097          	auipc	ra,0x3
    2e52:	c02080e7          	jalr	-1022(ra) # 5a50 <printf>
    exit(1);
    2e56:	4505                	li	a0,1
    ...
    2e66:	2c650513          	addi	a0,a0,710 # 7128 <malloc+0x161a>
    2e6a:	00003097          	auipc	ra,0x3
    2e6e:	be6080e7          	jalr	-1050(ra) # 5a50 <printf>
    exit(1);
    2e72:	4505                	li	a0,1
    ...
    2e82:	2d250513          	addi	a0,a0,722 # 7150 <malloc+0x1642>
    2e86:	00003097          	auipc	ra,0x3
    2e8a:	bca080e7          	jalr	-1078(ra) # 5a50 <printf>
    exit(1);
    2e8e:	4505                	li	a0,1
...
0000000000002e98 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2eb6:	22650513          	addi	a0,a0,550 # 70d8 <malloc+0x15ca>
    ...
    2eca:	21250513          	addi	a0,a0,530 # 70d8 <malloc+0x15ca>
    ...
    2ede:	23e50513          	addi	a0,a0,574 # 7118 <malloc+0x160a>
    ...
    2efe:	89e50513          	addi	a0,a0,-1890 # 6798 <malloc+0xc8a>
    2f02:	00003097          	auipc	ra,0x3
    2f06:	b4e080e7          	jalr	-1202(ra) # 5a50 <printf>
    exit(1);
    2f0a:	4505                	li	a0,1
    ...
    2f1a:	1ca50513          	addi	a0,a0,458 # 70e0 <malloc+0x15d2>
    2f1e:	00003097          	auipc	ra,0x3
    2f22:	b32080e7          	jalr	-1230(ra) # 5a50 <printf>
      exit(1);
    2f26:	4505                	li	a0,1
    ...
    2f36:	23650513          	addi	a0,a0,566 # 7168 <malloc+0x165a>
    2f3a:	00003097          	auipc	ra,0x3
    2f3e:	b16080e7          	jalr	-1258(ra) # 5a50 <printf>
      exit(1);
    2f42:	4505                	li	a0,1
    ...
    2f52:	1da50513          	addi	a0,a0,474 # 7128 <malloc+0x161a>
    2f56:	00003097          	auipc	ra,0x3
    2f5a:	afa080e7          	jalr	-1286(ra) # 5a50 <printf>
      exit(1);
    2f5e:	4505                	li	a0,1
...
0000000000002f80 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f90:	1f450513          	addi	a0,a0,500 # 7180 <malloc+0x1672>
  ...
  if(chdir("dir0") < 0){
    ...
    2fa4:	1e050513          	addi	a0,a0,480 # 7180 <malloc+0x1672>
  ...
  if(chdir("..") < 0){
    ...
    2fb8:	1ec50513          	addi	a0,a0,492 # 71a0 <malloc+0x1692>
  ...
  if(unlink("dir0") < 0){
    ...
    2fcc:	1b850513          	addi	a0,a0,440 # 7180 <malloc+0x1672>
    ...
    2fec:	0f850513          	addi	a0,a0,248 # 70e0 <malloc+0x15d2>
    2ff0:	00003097          	auipc	ra,0x3
    2ff4:	a60080e7          	jalr	-1440(ra) # 5a50 <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3008:	18450513          	addi	a0,a0,388 # 7188 <malloc+0x167a>
    300c:	00003097          	auipc	ra,0x3
    3010:	a44080e7          	jalr	-1468(ra) # 5a50 <printf>
    exit(1);
    3014:	4505                	li	a0,1
    ...
    3024:	18850513          	addi	a0,a0,392 # 71a8 <malloc+0x169a>
    3028:	00003097          	auipc	ra,0x3
    302c:	a28080e7          	jalr	-1496(ra) # 5a50 <printf>
    exit(1);
    3030:	4505                	li	a0,1
    ...
    3040:	18450513          	addi	a0,a0,388 # 71c0 <malloc+0x16b2>
    3044:	00003097          	auipc	ra,0x3
    3048:	a0c080e7          	jalr	-1524(ra) # 5a50 <printf>
    exit(1);
    304c:	4505                	li	a0,1
...
0000000000003056 <subdir>:
{
  ...
  unlink("ff");
    ...
    3068:	2a450513          	addi	a0,a0,676 # 7308 <malloc+0x17fa>
    306c:	00002097          	auipc	ra,0x2
    3070:	684080e7          	jalr	1668(ra) # 56f0 <unlink>
  if(mkdir("dd") != 0){
    3074:	00004517          	auipc	a0,0x4
    3078:	16450513          	addi	a0,a0,356 # 71d8 <malloc+0x16ca>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3090:	16c50513          	addi	a0,a0,364 # 71f8 <malloc+0x16ea>
  ...
  write(fd, "ff", 2);
    ...
    30a8:	26458593          	addi	a1,a1,612 # 7308 <malloc+0x17fa>
  ...
  if(unlink("dd") >= 0){
    ...
    30c2:	11a50513          	addi	a0,a0,282 # 71d8 <malloc+0x16ca>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30d6:	17e50513          	addi	a0,a0,382 # 7250 <malloc+0x1742>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30ee:	18e50513          	addi	a0,a0,398 # 7278 <malloc+0x176a>
  ...
  write(fd, "FF", 2);
    ...
    3106:	1a658593          	addi	a1,a1,422 # 72a8 <malloc+0x179a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3122:	19250513          	addi	a0,a0,402 # 72b0 <malloc+0x17a2>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    313a:	a7258593          	addi	a1,a1,-1422 # bba8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3150:	a5c74703          	lbu	a4,-1444(a4) # bba8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    316a:	19a58593          	addi	a1,a1,410 # 7300 <malloc+0x17f2>
    316e:	00004517          	auipc	a0,0x4
    3172:	10a50513          	addi	a0,a0,266 # 7278 <malloc+0x176a>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3186:	0f650513          	addi	a0,a0,246 # 7278 <malloc+0x176a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    319c:	0e050513          	addi	a0,a0,224 # 7278 <malloc+0x176a>
  ...
  if(chdir("dd") != 0){
    ...
    31b0:	02c50513          	addi	a0,a0,44 # 71d8 <malloc+0x16ca>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31c4:	1d850513          	addi	a0,a0,472 # 7398 <malloc+0x188a>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31d8:	1f450513          	addi	a0,a0,500 # 73c8 <malloc+0x18ba>
  ...
  if(chdir("./..") != 0){
    ...
    31ec:	21050513          	addi	a0,a0,528 # 73f8 <malloc+0x18ea>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3202:	10250513          	addi	a0,a0,258 # 7300 <malloc+0x17f2>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    321a:	99258593          	addi	a1,a1,-1646 # bba8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    323c:	04050513          	addi	a0,a0,64 # 7278 <malloc+0x176a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3254:	23850513          	addi	a0,a0,568 # 7488 <malloc+0x197a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    326c:	25050513          	addi	a0,a0,592 # 74b8 <malloc+0x19aa>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3284:	f5850513          	addi	a0,a0,-168 # 71d8 <malloc+0x16ca>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    329a:	f4250513          	addi	a0,a0,-190 # 71d8 <malloc+0x16ca>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b0:	f2c50513          	addi	a0,a0,-212 # 71d8 <malloc+0x16ca>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32c4:	28858593          	addi	a1,a1,648 # 7548 <malloc+0x1a3a>
    32c8:	00004517          	auipc	a0,0x4
    32cc:	1c050513          	addi	a0,a0,448 # 7488 <malloc+0x197a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32e0:	26c58593          	addi	a1,a1,620 # 7548 <malloc+0x1a3a>
    32e4:	00004517          	auipc	a0,0x4
    32e8:	1d450513          	addi	a0,a0,468 # 74b8 <malloc+0x19aa>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    32fc:	00858593          	addi	a1,a1,8 # 7300 <malloc+0x17f2>
    3300:	00004517          	auipc	a0,0x4
    3304:	ef850513          	addi	a0,a0,-264 # 71f8 <malloc+0x16ea>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3318:	17450513          	addi	a0,a0,372 # 7488 <malloc+0x197a>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    332c:	19050513          	addi	a0,a0,400 # 74b8 <malloc+0x19aa>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3340:	fc450513          	addi	a0,a0,-60 # 7300 <malloc+0x17f2>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3354:	16850513          	addi	a0,a0,360 # 74b8 <malloc+0x19aa>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3368:	12450513          	addi	a0,a0,292 # 7488 <malloc+0x197a>
  ...
  if(chdir("dd/ff") == 0){
    ...
    337c:	e8050513          	addi	a0,a0,-384 # 71f8 <malloc+0x16ea>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3390:	30c50513          	addi	a0,a0,780 # 7698 <malloc+0x1b8a>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33a4:	f6050513          	addi	a0,a0,-160 # 7300 <malloc+0x17f2>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33b8:	e4450513          	addi	a0,a0,-444 # 71f8 <malloc+0x16ea>
  ...
  if(unlink("dd") == 0){
    ...
    33cc:	e1050513          	addi	a0,a0,-496 # 71d8 <malloc+0x16ca>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e0:	32c50513          	addi	a0,a0,812 # 7708 <malloc+0x1bfa>
  ...
  if(unlink("dd") < 0){
    ...
    33f4:	de850513          	addi	a0,a0,-536 # 71d8 <malloc+0x16ca>
    ...
    3416:	dce50513          	addi	a0,a0,-562 # 71e0 <malloc+0x16d2>
    341a:	00002097          	auipc	ra,0x2
    341e:	636080e7          	jalr	1590(ra) # 5a50 <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    3432:	dd250513          	addi	a0,a0,-558 # 7200 <malloc+0x16f2>
    3436:	00002097          	auipc	ra,0x2
    343a:	61a080e7          	jalr	1562(ra) # 5a50 <printf>
    exit(1);
    343e:	4505                	li	a0,1
    ...
    344e:	dd650513          	addi	a0,a0,-554 # 7220 <malloc+0x1712>
    3452:	00002097          	auipc	ra,0x2
    3456:	5fe080e7          	jalr	1534(ra) # 5a50 <printf>
    exit(1);
    345a:	4505                	li	a0,1
    ...
    346a:	df250513          	addi	a0,a0,-526 # 7258 <malloc+0x174a>
    346e:	00002097          	auipc	ra,0x2
    3472:	5e2080e7          	jalr	1506(ra) # 5a50 <printf>
    exit(1);
    3476:	4505                	li	a0,1
    ...
    3486:	e0650513          	addi	a0,a0,-506 # 7288 <malloc+0x177a>
    348a:	00002097          	auipc	ra,0x2
    348e:	5c6080e7          	jalr	1478(ra) # 5a50 <printf>
    exit(1);
    3492:	4505                	li	a0,1
    ...
    34a2:	e2250513          	addi	a0,a0,-478 # 72c0 <malloc+0x17b2>
    34a6:	00002097          	auipc	ra,0x2
    34aa:	5aa080e7          	jalr	1450(ra) # 5a50 <printf>
    exit(1);
    34ae:	4505                	li	a0,1
    ...
    34be:	e2650513          	addi	a0,a0,-474 # 72e0 <malloc+0x17d2>
    34c2:	00002097          	auipc	ra,0x2
    34c6:	58e080e7          	jalr	1422(ra) # 5a50 <printf>
    exit(1);
    34ca:	4505                	li	a0,1
    ...
    34da:	e3a50513          	addi	a0,a0,-454 # 7310 <malloc+0x1802>
    34de:	00002097          	auipc	ra,0x2
    34e2:	572080e7          	jalr	1394(ra) # 5a50 <printf>
    exit(1);
    34e6:	4505                	li	a0,1
    ...
    34f6:	e4650513          	addi	a0,a0,-442 # 7338 <malloc+0x182a>
    34fa:	00002097          	auipc	ra,0x2
    34fe:	556080e7          	jalr	1366(ra) # 5a50 <printf>
    exit(1);
    3502:	4505                	li	a0,1
    ...
    3512:	e4a50513          	addi	a0,a0,-438 # 7358 <malloc+0x184a>
    3516:	00002097          	auipc	ra,0x2
    351a:	53a080e7          	jalr	1338(ra) # 5a50 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352e:	e5650513          	addi	a0,a0,-426 # 7380 <malloc+0x1872>
    3532:	00002097          	auipc	ra,0x2
    3536:	51e080e7          	jalr	1310(ra) # 5a50 <printf>
    exit(1);
    353a:	4505                	li	a0,1
    ...
    354a:	e6250513          	addi	a0,a0,-414 # 73a8 <malloc+0x189a>
    354e:	00002097          	auipc	ra,0x2
    3552:	502080e7          	jalr	1282(ra) # 5a50 <printf>
    exit(1);
    3556:	4505                	li	a0,1
    ...
    3566:	e7650513          	addi	a0,a0,-394 # 73d8 <malloc+0x18ca>
    356a:	00002097          	auipc	ra,0x2
    356e:	4e6080e7          	jalr	1254(ra) # 5a50 <printf>
    exit(1);
    3572:	4505                	li	a0,1
    ...
    3582:	e8250513          	addi	a0,a0,-382 # 7400 <malloc+0x18f2>
    3586:	00002097          	auipc	ra,0x2
    358a:	4ca080e7          	jalr	1226(ra) # 5a50 <printf>
    exit(1);
    358e:	4505                	li	a0,1
    ...
    359e:	e7e50513          	addi	a0,a0,-386 # 7418 <malloc+0x190a>
    35a2:	00002097          	auipc	ra,0x2
    35a6:	4ae080e7          	jalr	1198(ra) # 5a50 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35ba:	e8250513          	addi	a0,a0,-382 # 7438 <malloc+0x192a>
    35be:	00002097          	auipc	ra,0x2
    35c2:	492080e7          	jalr	1170(ra) # 5a50 <printf>
    exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d6:	e8650513          	addi	a0,a0,-378 # 7458 <malloc+0x194a>
    35da:	00002097          	auipc	ra,0x2
    35de:	476080e7          	jalr	1142(ra) # 5a50 <printf>
    exit(1);
    35e2:	4505                	li	a0,1
    ...
    35f2:	eaa50513          	addi	a0,a0,-342 # 7498 <malloc+0x198a>
    35f6:	00002097          	auipc	ra,0x2
    35fa:	45a080e7          	jalr	1114(ra) # 5a50 <printf>
    exit(1);
    35fe:	4505                	li	a0,1
    ...
    360e:	ebe50513          	addi	a0,a0,-322 # 74c8 <malloc+0x19ba>
    3612:	00002097          	auipc	ra,0x2
    3616:	43e080e7          	jalr	1086(ra) # 5a50 <printf>
    exit(1);
    361a:	4505                	li	a0,1
    ...
    362a:	ec250513          	addi	a0,a0,-318 # 74e8 <malloc+0x19da>
    362e:	00002097          	auipc	ra,0x2
    3632:	422080e7          	jalr	1058(ra) # 5a50 <printf>
    exit(1);
    3636:	4505                	li	a0,1
    ...
    3646:	ec650513          	addi	a0,a0,-314 # 7508 <malloc+0x19fa>
    364a:	00002097          	auipc	ra,0x2
    364e:	406080e7          	jalr	1030(ra) # 5a50 <printf>
    exit(1);
    3652:	4505                	li	a0,1
    ...
    3662:	eca50513          	addi	a0,a0,-310 # 7528 <malloc+0x1a1a>
    3666:	00002097          	auipc	ra,0x2
    366a:	3ea080e7          	jalr	1002(ra) # 5a50 <printf>
    exit(1);
    366e:	4505                	li	a0,1
    ...
    367e:	ede50513          	addi	a0,a0,-290 # 7558 <malloc+0x1a4a>
    3682:	00002097          	auipc	ra,0x2
    3686:	3ce080e7          	jalr	974(ra) # 5a50 <printf>
    exit(1);
    368a:	4505                	li	a0,1
    ...
    369a:	eea50513          	addi	a0,a0,-278 # 7580 <malloc+0x1a72>
    369e:	00002097          	auipc	ra,0x2
    36a2:	3b2080e7          	jalr	946(ra) # 5a50 <printf>
    exit(1);
    36a6:	4505                	li	a0,1
    ...
    36b6:	ef650513          	addi	a0,a0,-266 # 75a8 <malloc+0x1a9a>
    36ba:	00002097          	auipc	ra,0x2
    36be:	396080e7          	jalr	918(ra) # 5a50 <printf>
    exit(1);
    36c2:	4505                	li	a0,1
    ...
    36d2:	f0250513          	addi	a0,a0,-254 # 75d0 <malloc+0x1ac2>
    36d6:	00002097          	auipc	ra,0x2
    36da:	37a080e7          	jalr	890(ra) # 5a50 <printf>
    exit(1);
    36de:	4505                	li	a0,1
    ...
    36ee:	f0650513          	addi	a0,a0,-250 # 75f0 <malloc+0x1ae2>
    36f2:	00002097          	auipc	ra,0x2
    36f6:	35e080e7          	jalr	862(ra) # 5a50 <printf>
    exit(1);
    36fa:	4505                	li	a0,1
    ...
    370a:	f0a50513          	addi	a0,a0,-246 # 7610 <malloc+0x1b02>
    370e:	00002097          	auipc	ra,0x2
    3712:	342080e7          	jalr	834(ra) # 5a50 <printf>
    exit(1);
    3716:	4505                	li	a0,1
    ...
    3726:	f1650513          	addi	a0,a0,-234 # 7638 <malloc+0x1b2a>
    372a:	00002097          	auipc	ra,0x2
    372e:	326080e7          	jalr	806(ra) # 5a50 <printf>
    exit(1);
    3732:	4505                	li	a0,1
    ...
    3742:	f1a50513          	addi	a0,a0,-230 # 7658 <malloc+0x1b4a>
    3746:	00002097          	auipc	ra,0x2
    374a:	30a080e7          	jalr	778(ra) # 5a50 <printf>
    exit(1);
    374e:	4505                	li	a0,1
    ...
    375e:	f1e50513          	addi	a0,a0,-226 # 7678 <malloc+0x1b6a>
    3762:	00002097          	auipc	ra,0x2
    3766:	2ee080e7          	jalr	750(ra) # 5a50 <printf>
    exit(1);
    376a:	4505                	li	a0,1
    ...
    377a:	f2a50513          	addi	a0,a0,-214 # 76a0 <malloc+0x1b92>
    377e:	00002097          	auipc	ra,0x2
    3782:	2d2080e7          	jalr	722(ra) # 5a50 <printf>
    exit(1);
    3786:	4505                	li	a0,1
    ...
    3796:	ba650513          	addi	a0,a0,-1114 # 7338 <malloc+0x182a>
    379a:	00002097          	auipc	ra,0x2
    379e:	2b6080e7          	jalr	694(ra) # 5a50 <printf>
    exit(1);
    37a2:	4505                	li	a0,1
    ...
    37b2:	f1250513          	addi	a0,a0,-238 # 76c0 <malloc+0x1bb2>
    37b6:	00002097          	auipc	ra,0x2
    37ba:	29a080e7          	jalr	666(ra) # 5a50 <printf>
    exit(1);
    37be:	4505                	li	a0,1
    ...
    37ce:	f1650513          	addi	a0,a0,-234 # 76e0 <malloc+0x1bd2>
    37d2:	00002097          	auipc	ra,0x2
    37d6:	27e080e7          	jalr	638(ra) # 5a50 <printf>
    exit(1);
    37da:	4505                	li	a0,1
    ...
    37ea:	f2a50513          	addi	a0,a0,-214 # 7710 <malloc+0x1c02>
    37ee:	00002097          	auipc	ra,0x2
    37f2:	262080e7          	jalr	610(ra) # 5a50 <printf>
    exit(1);
    37f6:	4505                	li	a0,1
    ...
    3806:	f2e50513          	addi	a0,a0,-210 # 7730 <malloc+0x1c22>
    380a:	00002097          	auipc	ra,0x2
    380e:	246080e7          	jalr	582(ra) # 5a50 <printf>
    exit(1);
    3812:	4505                	li	a0,1
...
000000000000381c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    382c:	f2050513          	addi	a0,a0,-224 # 7748 <malloc+0x1c3a>
  ...
  if(chdir("dots") != 0){
    ...
    383e:	f0e50513          	addi	a0,a0,-242 # 7748 <malloc+0x1c3a>
  ...
  if(unlink(".") == 0){
    ...
    3850:	dac50513          	addi	a0,a0,-596 # 65f8 <malloc+0xaea>
  ...
  if(unlink("..") == 0){
    ...
    3862:	94250513          	addi	a0,a0,-1726 # 71a0 <malloc+0x1692>
  ...
  if(chdir("/") != 0){
    ...
    3874:	8d850513          	addi	a0,a0,-1832 # 7148 <malloc+0x163a>
  ...
  if(unlink("dots/.") == 0){
    ...
    3886:	f2e50513          	addi	a0,a0,-210 # 77b0 <malloc+0x1ca2>
  ...
  if(unlink("dots/..") == 0){
    ...
    3898:	f4450513          	addi	a0,a0,-188 # 77d8 <malloc+0x1cca>
  ...
  if(unlink("dots") != 0){
    ...
    38aa:	ea250513          	addi	a0,a0,-350 # 7748 <malloc+0x1c3a>
    ...
    38c8:	e8c50513          	addi	a0,a0,-372 # 7750 <malloc+0x1c42>
    38cc:	00002097          	auipc	ra,0x2
    38d0:	184080e7          	jalr	388(ra) # 5a50 <printf>
    exit(1);
    38d4:	4505                	li	a0,1
    ...
    38e4:	e8850513          	addi	a0,a0,-376 # 7768 <malloc+0x1c5a>
    38e8:	00002097          	auipc	ra,0x2
    38ec:	168080e7          	jalr	360(ra) # 5a50 <printf>
    exit(1);
    38f0:	4505                	li	a0,1
    ...
    3900:	e8450513          	addi	a0,a0,-380 # 7780 <malloc+0x1c72>
    3904:	00002097          	auipc	ra,0x2
    3908:	14c080e7          	jalr	332(ra) # 5a50 <printf>
    exit(1);
    390c:	4505                	li	a0,1
    ...
    391c:	e8050513          	addi	a0,a0,-384 # 7798 <malloc+0x1c8a>
    3920:	00002097          	auipc	ra,0x2
    3924:	130080e7          	jalr	304(ra) # 5a50 <printf>
    exit(1);
    3928:	4505                	li	a0,1
    ...
    3938:	81c50513          	addi	a0,a0,-2020 # 7150 <malloc+0x1642>
    393c:	00002097          	auipc	ra,0x2
    3940:	114080e7          	jalr	276(ra) # 5a50 <printf>
    exit(1);
    3944:	4505                	li	a0,1
    ...
    3954:	e6850513          	addi	a0,a0,-408 # 77b8 <malloc+0x1caa>
    3958:	00002097          	auipc	ra,0x2
    395c:	0f8080e7          	jalr	248(ra) # 5a50 <printf>
    exit(1);
    3960:	4505                	li	a0,1
    ...
    3970:	e7450513          	addi	a0,a0,-396 # 77e0 <malloc+0x1cd2>
    3974:	00002097          	auipc	ra,0x2
    3978:	0dc080e7          	jalr	220(ra) # 5a50 <printf>
    exit(1);
    397c:	4505                	li	a0,1
    ...
    398c:	e7850513          	addi	a0,a0,-392 # 7800 <malloc+0x1cf2>
    3990:	00002097          	auipc	ra,0x2
    3994:	0c0080e7          	jalr	192(ra) # 5a50 <printf>
    exit(1);
    3998:	4505                	li	a0,1
...
00000000000039a2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39b8:	54c50513          	addi	a0,a0,1356 # 5f00 <malloc+0x3f2>
  ...
  if(chdir("dirfile") == 0){
    ...
    39d4:	53050513          	addi	a0,a0,1328 # 5f00 <malloc+0x3f2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    39e8:	e7c50513          	addi	a0,a0,-388 # 7860 <malloc+0x1d52>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a00:	e6450513          	addi	a0,a0,-412 # 7860 <malloc+0x1d52>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a14:	e5050513          	addi	a0,a0,-432 # 7860 <malloc+0x1d52>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a28:	e3c50513          	addi	a0,a0,-452 # 7860 <malloc+0x1d52>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a3c:	e2858593          	addi	a1,a1,-472 # 7860 <malloc+0x1d52>
    3a40:	00002517          	auipc	a0,0x2
    3a44:	6b850513          	addi	a0,a0,1720 # 60f8 <malloc+0x5ea>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a58:	4ac50513          	addi	a0,a0,1196 # 5f00 <malloc+0x3f2>
  ...
  fd = open(".", O_RDWR);
    ...
    3a6e:	b8e50513          	addi	a0,a0,-1138 # 65f8 <malloc+0xaea>
  ...
  fd = open(".", 0);
    ...
    3a84:	b7850513          	addi	a0,a0,-1160 # 65f8 <malloc+0xaea>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3a98:	53c58593          	addi	a1,a1,1340 # 5fd0 <malloc+0x4c2>
  ...
  close(fd);
    ...
    3ac4:	d6050513          	addi	a0,a0,-672 # 7820 <malloc+0x1d12>
    3ac8:	00002097          	auipc	ra,0x2
    3acc:	f88080e7          	jalr	-120(ra) # 5a50 <printf>
    exit(1);
    3ad0:	4505                	li	a0,1
    ...
    3ae0:	d6450513          	addi	a0,a0,-668 # 7840 <malloc+0x1d32>
    3ae4:	00002097          	auipc	ra,0x2
    3ae8:	f6c080e7          	jalr	-148(ra) # 5a50 <printf>
    exit(1);
    3aec:	4505                	li	a0,1
    ...
    3afc:	d7850513          	addi	a0,a0,-648 # 7870 <malloc+0x1d62>
    3b00:	00002097          	auipc	ra,0x2
    3b04:	f50080e7          	jalr	-176(ra) # 5a50 <printf>
    exit(1);
    3b08:	4505                	li	a0,1
    ...
    3b18:	d5c50513          	addi	a0,a0,-676 # 7870 <malloc+0x1d62>
    3b1c:	00002097          	auipc	ra,0x2
    3b20:	f34080e7          	jalr	-204(ra) # 5a50 <printf>
    exit(1);
    3b24:	4505                	li	a0,1
    ...
    3b34:	d6850513          	addi	a0,a0,-664 # 7898 <malloc+0x1d8a>
    3b38:	00002097          	auipc	ra,0x2
    3b3c:	f18080e7          	jalr	-232(ra) # 5a50 <printf>
    exit(1);
    3b40:	4505                	li	a0,1
    ...
    3b50:	d7450513          	addi	a0,a0,-652 # 78c0 <malloc+0x1db2>
    3b54:	00002097          	auipc	ra,0x2
    3b58:	efc080e7          	jalr	-260(ra) # 5a50 <printf>
    exit(1);
    3b5c:	4505                	li	a0,1
    ...
    3b6c:	d8050513          	addi	a0,a0,-640 # 78e8 <malloc+0x1dda>
    3b70:	00002097          	auipc	ra,0x2
    3b74:	ee0080e7          	jalr	-288(ra) # 5a50 <printf>
    exit(1);
    3b78:	4505                	li	a0,1
    ...
    3b88:	d8c50513          	addi	a0,a0,-628 # 7910 <malloc+0x1e02>
    3b8c:	00002097          	auipc	ra,0x2
    3b90:	ec4080e7          	jalr	-316(ra) # 5a50 <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba4:	d9050513          	addi	a0,a0,-624 # 7930 <malloc+0x1e22>
    3ba8:	00002097          	auipc	ra,0x2
    3bac:	ea8080e7          	jalr	-344(ra) # 5a50 <printf>
    exit(1);
    3bb0:	4505                	li	a0,1
    ...
    3bc0:	d9c50513          	addi	a0,a0,-612 # 7958 <malloc+0x1e4a>
    3bc4:	00002097          	auipc	ra,0x2
    3bc8:	e8c080e7          	jalr	-372(ra) # 5a50 <printf>
    exit(1);
    3bcc:	4505                	li	a0,1
...
0000000000003bd6 <iref>:
{
    ...
    3bf4:	d80a0a13          	addi	s4,s4,-640 # 7970 <malloc+0x1e62>
    mkdir("");
    3bf8:	00004497          	auipc	s1,0x4
    3bfc:	88848493          	addi	s1,s1,-1912 # 7480 <malloc+0x1972>
    link("README", "");
    3c00:	00002a97          	auipc	s5,0x2
    3c04:	4f8a8a93          	addi	s5,s5,1272 # 60f8 <malloc+0x5ea>
    fd = open("xx", O_CREATE);
    3c08:	00004997          	auipc	s3,0x4
    3c0c:	c6098993          	addi	s3,s3,-928 # 7868 <malloc+0x1d5a>
    3c10:	a891                	j	3c64 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c12:	85da                	mv	a1,s6
    3c14:	00004517          	auipc	a0,0x4
    3c18:	d6450513          	addi	a0,a0,-668 # 7978 <malloc+0x1e6a>
    3c1c:	00002097          	auipc	ra,0x2
    3c20:	e34080e7          	jalr	-460(ra) # 5a50 <printf>
      exit(1);
    3c24:	4505                	li	a0,1
    ...
    3c34:	d6050513          	addi	a0,a0,-672 # 7990 <malloc+0x1e82>
    3c38:	00002097          	auipc	ra,0x2
    3c3c:	e18080e7          	jalr	-488(ra) # 5a50 <printf>
      exit(1);
    3c40:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cc8:	4dc98993          	addi	s3,s3,1244 # 71a0 <malloc+0x1692>
    unlink("irefd");
    3ccc:	00004917          	auipc	s2,0x4
    3cd0:	ca490913          	addi	s2,s2,-860 # 7970 <malloc+0x1e62>
    chdir("..");
    3cd4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3cf0:	45c50513          	addi	a0,a0,1116 # 7148 <malloc+0x163a>
...
0000000000003d10 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d20:	c8c50513          	addi	a0,a0,-884 # 79a8 <malloc+0x1e9a>
  ...
  if(pid == 0){
    ...
    3d44:	c6850513          	addi	a0,a0,-920 # 79a8 <malloc+0x1e9a>
    ...
    3d5a:	c7250513          	addi	a0,a0,-910 # 79c8 <malloc+0x1eba>
    3d5e:	00002097          	auipc	ra,0x2
    3d62:	cf2080e7          	jalr	-782(ra) # 5a50 <printf>
      exit(1);
    3d66:	4505                	li	a0,1
    ...
    3d76:	c3e50513          	addi	a0,a0,-962 # 79b0 <malloc+0x1ea2>
    3d7a:	00002097          	auipc	ra,0x2
    3d7e:	cd6080e7          	jalr	-810(ra) # 5a50 <printf>
    exit(1);
    3d82:	4505                	li	a0,1
    ...
    3d92:	a0a50513          	addi	a0,a0,-1526 # 6798 <malloc+0xc8a>
    3d96:	00002097          	auipc	ra,0x2
    3d9a:	cba080e7          	jalr	-838(ra) # 5a50 <printf>
    exit(1);
    3d9e:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3dc0:	bec50513          	addi	a0,a0,-1044 # 79a8 <malloc+0x1e9a>
    ...
    3dd4:	bb850513          	addi	a0,a0,-1096 # 6988 <malloc+0xe7a>
    3dd8:	00002097          	auipc	ra,0x2
    3ddc:	c78080e7          	jalr	-904(ra) # 5a50 <printf>
    exit(1);
    3de0:	4505                	li	a0,1
...
0000000000003e02 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e12:	be250513          	addi	a0,a0,-1054 # 79f0 <malloc+0x1ee2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e3e:	bb650513          	addi	a0,a0,-1098 # 79f0 <malloc+0x1ee2>
  ...
  sleep(10); // one second
    ...
    3e76:	ae650513          	addi	a0,a0,-1306 # 6958 <malloc+0xe4a>
    3e7a:	00002097          	auipc	ra,0x2
    3e7e:	bd6080e7          	jalr	-1066(ra) # 5a50 <printf>
    exit(1);
    3e82:	4505                	li	a0,1
    ...
    3e90:	b6448493          	addi	s1,s1,-1180 # 79f0 <malloc+0x1ee2>
    3e94:	4581                	li	a1,0
    3e96:	8526                	mv	a0,s1
...
0000000000003ed2 <killstatus>:
{
  ...
  exit(0);
    ...
    3f38:	86450513          	addi	a0,a0,-1948 # 6798 <malloc+0xc8a>
    3f3c:	00002097          	auipc	ra,0x2
    3f40:	b14080e7          	jalr	-1260(ra) # 5a50 <printf>
      exit(1);
    3f44:	4505                	li	a0,1
    ...
    3f5e:	aa650513          	addi	a0,a0,-1370 # 7a00 <malloc+0x1ef2>
    3f62:	00002097          	auipc	ra,0x2
    3f66:	aee080e7          	jalr	-1298(ra) # 5a50 <printf>
       exit(1);
    3f6a:	4505                	li	a0,1
...
0000000000003f74 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3f9e:	9be50513          	addi	a0,a0,-1602 # 6958 <malloc+0xe4a>
    3fa2:	00002097          	auipc	ra,0x2
    3fa6:	aae080e7          	jalr	-1362(ra) # 5a50 <printf>
    exit(1);
    3faa:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3fcc:	7d050513          	addi	a0,a0,2000 # 6798 <malloc+0xc8a>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	a80080e7          	jalr	-1408(ra) # 5a50 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4010:	fc458593          	addi	a1,a1,-60 # 5fd0 <malloc+0x4c2>
    ...
    403a:	76250513          	addi	a0,a0,1890 # 6798 <malloc+0xc8a>
    403e:	00002097          	auipc	ra,0x2
    4042:	a12080e7          	jalr	-1518(ra) # 5a50 <printf>
     exit(1);
    4046:	4505                	li	a0,1
    ...
    4056:	9ce50513          	addi	a0,a0,-1586 # 7a20 <malloc+0x1f12>
    405a:	00002097          	auipc	ra,0x2
    405e:	9f6080e7          	jalr	-1546(ra) # 5a50 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4076:	b3658593          	addi	a1,a1,-1226 # bba8 <buf>
    ...
    4092:	9aa50513          	addi	a0,a0,-1622 # 7a38 <malloc+0x1f2a>
    4096:	00002097          	auipc	ra,0x2
    409a:	9ba080e7          	jalr	-1606(ra) # 5a50 <printf>
}
  ...
  printf("kill... ");
    ...
    40be:	99650513          	addi	a0,a0,-1642 # 7a50 <malloc+0x1f42>
    40c2:	00002097          	auipc	ra,0x2
    40c6:	98e080e7          	jalr	-1650(ra) # 5a50 <printf>
  kill(pid1);
    40ca:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    40ec:	97850513          	addi	a0,a0,-1672 # 7a60 <malloc+0x1f52>
    40f0:	00002097          	auipc	ra,0x2
    40f4:	960080e7          	jalr	-1696(ra) # 5a50 <printf>
  wait(0);
    40f8:	4501                	li	a0,0
...
0000000000004118 <reparent>:
{
  ...
  exit(0);
    ...
    416c:	63050513          	addi	a0,a0,1584 # 6798 <malloc+0xc8a>
    4170:	00002097          	auipc	ra,0x2
    4174:	8e0080e7          	jalr	-1824(ra) # 5a50 <printf>
      exit(1);
    4178:	4505                	li	a0,1
    ...
    4188:	79c50513          	addi	a0,a0,1948 # 6920 <malloc+0xe12>
    418c:	00002097          	auipc	ra,0x2
    4190:	8c4080e7          	jalr	-1852(ra) # 5a50 <printf>
        exit(1);
    4194:	4505                	li	a0,1
...
00000000000041c8 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    41fe:	6a650513          	addi	a0,a0,1702 # 68a0 <malloc+0xd92>
    4202:	00002097          	auipc	ra,0x2
    4206:	84e080e7          	jalr	-1970(ra) # 5a50 <printf>
    exit(1);
    420a:	4505                	li	a0,1
    ...
    4232:	da258593          	addi	a1,a1,-606 # 5fd0 <malloc+0x4c2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    42f6:	77e50513          	addi	a0,a0,1918 # 7a70 <malloc+0x1f62>
    42fa:	00001097          	auipc	ra,0x1
    42fe:	756080e7          	jalr	1878(ra) # 5a50 <printf>
    exit(1);
    4302:	4505                	li	a0,1
    ...
    4312:	48a50513          	addi	a0,a0,1162 # 6798 <malloc+0xc8a>
    4316:	00001097          	auipc	ra,0x1
    431a:	73a080e7          	jalr	1850(ra) # 5a50 <printf>
    exit(1);
    431e:	4505                	li	a0,1
    ...
    4348:	6705                	lui	a4,0x1
      n += *(a+i);
    434a:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1448>
    ...
    435e:	73650513          	addi	a0,a0,1846 # 7a90 <malloc+0x1f82>
    4362:	00001097          	auipc	ra,0x1
    4366:	6ee080e7          	jalr	1774(ra) # 5a50 <printf>
    exit(1);
    436a:	4505                	li	a0,1
...
000000000000437e <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    43c8:	74a080e7          	jalr	1866(ra) # 5b0e <malloc>
    ...
    4402:	6c250513          	addi	a0,a0,1730 # 7ac0 <malloc+0x1fb2>
    4406:	00001097          	auipc	ra,0x1
    440a:	64a080e7          	jalr	1610(ra) # 5a50 <printf>
      exit(1);
    440e:	4505                	li	a0,1
...
0000000000004422 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    44b8:	62c50513          	addi	a0,a0,1580 # 7ae0 <malloc+0x1fd2>
    44bc:	00001097          	auipc	ra,0x1
    44c0:	594080e7          	jalr	1428(ra) # 5a50 <printf>
    exit(1);
    44c4:	4505                	li	a0,1
    ...
    44d4:	63850513          	addi	a0,a0,1592 # 7b08 <malloc+0x1ffa>
    44d8:	00001097          	auipc	ra,0x1
    44dc:	578080e7          	jalr	1400(ra) # 5a50 <printf>
      exit(1);
    44e0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4518:	87c50513          	addi	a0,a0,-1924 # 5d90 <malloc+0x282>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4558:	5d450513          	addi	a0,a0,1492 # 7b28 <malloc+0x201a>
    455c:	00001097          	auipc	ra,0x1
    4560:	4f4080e7          	jalr	1268(ra) # 5a50 <printf>
    exit(1);
    4564:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4594:	80050513          	addi	a0,a0,-2048 # 5d90 <malloc+0x282>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    45ba:	59a50513          	addi	a0,a0,1434 # 7b50 <malloc+0x2042>
    45be:	00001097          	auipc	ra,0x1
    45c2:	492080e7          	jalr	1170(ra) # 5a50 <printf>
    exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4600:	5fc78793          	addi	a5,a5,1532 # 5bf8 <malloc+0xea>
    4604:	f6f43823          	sd	a5,-144(s0)
    4608:	00001797          	auipc	a5,0x1
    460c:	5f878793          	addi	a5,a5,1528 # 5c00 <malloc+0xf2>
    4610:	f6f43c23          	sd	a5,-136(s0)
    4614:	00001797          	auipc	a5,0x1
    4618:	5f478793          	addi	a5,a5,1524 # 5c08 <malloc+0xfa>
    461c:	f8f43023          	sd	a5,-128(s0)
    4620:	00001797          	auipc	a5,0x1
    4624:	5f078793          	addi	a5,a5,1520 # 5c10 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    467c:	530a0a13          	addi	s4,s4,1328 # bba8 <buf>
    4680:	00007a97          	auipc	s5,0x7
    4684:	529a8a93          	addi	s5,s5,1321 # bba9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    469c:	50850513          	addi	a0,a0,1288 # 6ba0 <malloc+0x1092>
    46a0:	00001097          	auipc	ra,0x1
    46a4:	3b0080e7          	jalr	944(ra) # 5a50 <printf>
      exit(1);
    46a8:	4505                	li	a0,1
    ...
    4718:	45450513          	addi	a0,a0,1108 # 7b68 <malloc+0x205a>
    471c:	00001097          	auipc	ra,0x1
    4720:	334080e7          	jalr	820(ra) # 5a50 <printf>
        exit(1);
    4724:	4505                	li	a0,1
    ...
    4732:	44a50513          	addi	a0,a0,1098 # 7b78 <malloc+0x206a>
    4736:	00001097          	auipc	ra,0x1
    473a:	31a080e7          	jalr	794(ra) # 5a50 <printf>
          exit(1);
    473e:	4505                	li	a0,1
    ...
    475a:	43a50513          	addi	a0,a0,1082 # 7b90 <malloc+0x2082>
    475e:	00001097          	auipc	ra,0x1
    4762:	2f2080e7          	jalr	754(ra) # 5a50 <printf>
          exit(1);
    4766:	4505                	li	a0,1
    ...
    478a:	42278793          	addi	a5,a5,1058 # bba8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    47e8:	3bc50513          	addi	a0,a0,956 # 7ba0 <malloc+0x2092>
    47ec:	00001097          	auipc	ra,0x1
    47f0:	264080e7          	jalr	612(ra) # 5a50 <printf>
      exit(1);
    47f4:	4505                	li	a0,1
...
000000000000481c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    484a:	372b8b93          	addi	s7,s7,882 # 7bb8 <malloc+0x20aa>
  for(i = 0; i < N; i++){
    ...
    488c:	33850513          	addi	a0,a0,824 # 7bc0 <malloc+0x20b2>
    4890:	00001097          	auipc	ra,0x1
    4894:	1c0080e7          	jalr	448(ra) # 5a50 <printf>
        exit(1);
    4898:	4505                	li	a0,1
    ...
    48aa:	31250513          	addi	a0,a0,786 # 7bb8 <malloc+0x20aa>
  ...
  fd = open(".", 0);
    ...
    48e2:	d1a50513          	addi	a0,a0,-742 # 65f8 <malloc+0xaea>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4958:	28c50513          	addi	a0,a0,652 # 7be0 <malloc+0x20d2>
    495c:	00001097          	auipc	ra,0x1
    4960:	0f4080e7          	jalr	244(ra) # 5a50 <printf>
        exit(1);
    4964:	4505                	li	a0,1
    ...
    4978:	28c50513          	addi	a0,a0,652 # 7c00 <malloc+0x20f2>
    497c:	00001097          	auipc	ra,0x1
    4980:	0d4080e7          	jalr	212(ra) # 5a50 <printf>
        exit(1);
    4984:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    49b0:	27c50513          	addi	a0,a0,636 # 7c28 <malloc+0x211a>
    49b4:	00001097          	auipc	ra,0x1
    49b8:	09c080e7          	jalr	156(ra) # 5a50 <printf>
    exit(1);
    49bc:	4505                	li	a0,1
    ...
    49cc:	dd050513          	addi	a0,a0,-560 # 6798 <malloc+0xc8a>
    49d0:	00001097          	auipc	ra,0x1
    49d4:	080080e7          	jalr	128(ra) # 5a50 <printf>
      exit(1);
    49d8:	4505                	li	a0,1
...
0000000000004b76 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4bb6:	ff690913          	addi	s2,s2,-10 # bba8 <buf>
  for(i = 0; i < N; i++){
    4bba:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4bfe:	06650513          	addi	a0,a0,102 # 7c60 <malloc+0x2152>
  ...
  for(i = 0; ; i++){
    ...
    4c14:	f9890913          	addi	s2,s2,-104 # bba8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4c62:	01250513          	addi	a0,a0,18 # 7c70 <malloc+0x2162>
    4c66:	00001097          	auipc	ra,0x1
    4c6a:	dea080e7          	jalr	-534(ra) # 5a50 <printf>
    exit(1);
    4c6e:	4505                	li	a0,1
    ...
    4c7e:	01650513          	addi	a0,a0,22 # 7c90 <malloc+0x2182>
    4c82:	00001097          	auipc	ra,0x1
    4c86:	dce080e7          	jalr	-562(ra) # 5a50 <printf>
      exit(1);
    4c8a:	4505                	li	a0,1
    ...
    4c9a:	01a50513          	addi	a0,a0,26 # 7cb0 <malloc+0x21a2>
    4c9e:	00001097          	auipc	ra,0x1
    4ca2:	db2080e7          	jalr	-590(ra) # 5a50 <printf>
    exit(1);
    4ca6:	4505                	li	a0,1
    ...
    4cb6:	01e50513          	addi	a0,a0,30 # 7cd0 <malloc+0x21c2>
    4cba:	00001097          	auipc	ra,0x1
    4cbe:	d96080e7          	jalr	-618(ra) # 5a50 <printf>
      exit(1);
    4cc2:	4505                	li	a0,1
    ...
    4cd2:	02250513          	addi	a0,a0,34 # 7cf0 <malloc+0x21e2>
    4cd6:	00001097          	auipc	ra,0x1
    4cda:	d7a080e7          	jalr	-646(ra) # 5a50 <printf>
      exit(1);
    4cde:	4505                	li	a0,1
    ...
    4cee:	01e50513          	addi	a0,a0,30 # 7d08 <malloc+0x21fa>
    4cf2:	00001097          	auipc	ra,0x1
    4cf6:	d5e080e7          	jalr	-674(ra) # 5a50 <printf>
      exit(1);
    4cfa:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4d1c:	f4850513          	addi	a0,a0,-184 # 7c60 <malloc+0x2152>
    ...
    4d40:	fec50513          	addi	a0,a0,-20 # 7d28 <malloc+0x221a>
    4d44:	00001097          	auipc	ra,0x1
    4d48:	d0c080e7          	jalr	-756(ra) # 5a50 <printf>
    exit(1);
    4d4c:	4505                	li	a0,1
...
0000000000004d56 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4d78:	fd450513          	addi	a0,a0,-44 # 7d48 <malloc+0x223a>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	cd4080e7          	jalr	-812(ra) # 5a50 <printf>
  for(nfiles = 0; ; nfiles++){
    4d84:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4d98:	fc4c8c93          	addi	s9,s9,-60 # 7d58 <malloc+0x224a>
    int total = 0;
    4d9c:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4d9e:	00007a17          	auipc	s4,0x7
    4da2:	e0aa0a13          	addi	s4,s4,-502 # bba8 <buf>
    name[0] = 'f';
    ...
    4df0:	c64080e7          	jalr	-924(ra) # 5a50 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4e12:	f5a50513          	addi	a0,a0,-166 # 7d68 <malloc+0x225a>
    4e16:	00001097          	auipc	ra,0x1
    4e1a:	c3a080e7          	jalr	-966(ra) # 5a50 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4e88:	f0450513          	addi	a0,a0,-252 # 7d88 <malloc+0x227a>
    4e8c:	00001097          	auipc	ra,0x1
    4e90:	bc4080e7          	jalr	-1084(ra) # 5a50 <printf>
}
    ...
    4ed8:	ea450513          	addi	a0,a0,-348 # 7d78 <malloc+0x226a>
    4edc:	00001097          	auipc	ra,0x1
    4ee0:	b74080e7          	jalr	-1164(ra) # 5a50 <printf>
    close(fd);
    4ee4:	854a                	mv	a0,s2
...
0000000000004ef6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4f00:	48470713          	addi	a4,a4,1156 # 8380 <randstate>
    4f04:	6308                	ld	a0,0(a4)
    4f06:	001967b7          	lui	a5,0x196
    4f0a:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187a55>
    4f0e:	02f50533          	mul	a0,a0,a5
    4f12:	3c6ef7b7          	lui	a5,0x3c6ef
    4f16:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e07a7>
...
0000000000004f26 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4f9a:	e0a50513          	addi	a0,a0,-502 # 7da0 <malloc+0x2292>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4fb2:	02258593          	addi	a1,a1,34 # 5fd0 <malloc+0x4c2>
    ...
    4fc8:	dfc50513          	addi	a0,a0,-516 # 7dc0 <malloc+0x22b2>
    4fcc:	00001097          	auipc	ra,0x1
    4fd0:	a84080e7          	jalr	-1404(ra) # 5a50 <printf>
    exit(1);
    4fd4:	4505                	li	a0,1
    ...
    4fe2:	dca50513          	addi	a0,a0,-566 # 7da8 <malloc+0x229a>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	a6a080e7          	jalr	-1430(ra) # 5a50 <printf>
      exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffc:	db050513          	addi	a0,a0,-592 # 7da8 <malloc+0x229a>
    5000:	00001097          	auipc	ra,0x1
    5004:	a50080e7          	jalr	-1456(ra) # 5a50 <printf>
    exit(1);
    5008:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    5020:	d8450513          	addi	a0,a0,-636 # 7da0 <malloc+0x2292>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5076:	f5e98993          	addi	s3,s3,-162 # 5fd0 <malloc+0x4c2>
      uint64 a = (uint64) sbrk(4096);
    ...
    50a8:	d6c50513          	addi	a0,a0,-660 # 7e10 <malloc+0x2302>
    50ac:	00001097          	auipc	ra,0x1
    50b0:	9a4080e7          	jalr	-1628(ra) # 5a50 <printf>
        exit(1);
    50b4:	4505                	li	a0,1
    ...
    50c2:	d1250513          	addi	a0,a0,-750 # 7dd0 <malloc+0x22c2>
    50c6:	00001097          	auipc	ra,0x1
    50ca:	98a080e7          	jalr	-1654(ra) # 5a50 <printf>
    exit(1);
    50ce:	4505                	li	a0,1
    ...
    50dc:	d1850513          	addi	a0,a0,-744 # 7df0 <malloc+0x22e2>
    50e0:	00001097          	auipc	ra,0x1
    50e4:	970080e7          	jalr	-1680(ra) # 5a50 <printf>
    exit(1);
    50e8:	4505                	li	a0,1
  ...
  while(1){
    ...
    512a:	d0a50513          	addi	a0,a0,-758 # 7e30 <malloc+0x2322>
    512e:	00001097          	auipc	ra,0x1
    5132:	922080e7          	jalr	-1758(ra) # 5a50 <printf>
      exit(1);
    5136:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    517a:	cda50513          	addi	a0,a0,-806 # 7e50 <malloc+0x2342>
    517e:	00001097          	auipc	ra,0x1
    5182:	8d2080e7          	jalr	-1838(ra) # 5a50 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    51aa:	cd250513          	addi	a0,a0,-814 # 7e78 <malloc+0x236a>
    51ae:	00001097          	auipc	ra,0x1
    51b2:	8a2080e7          	jalr	-1886(ra) # 5a50 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    51ce:	c9650513          	addi	a0,a0,-874 # 7e60 <malloc+0x2352>
    51d2:	00001097          	auipc	ra,0x1
    51d6:	87e080e7          	jalr	-1922(ra) # 5a50 <printf>
    exit(1);
    51da:	4505                	li	a0,1
    ...
    51f6:	c8e50513          	addi	a0,a0,-882 # 7e80 <malloc+0x2372>
    51fa:	00001097          	auipc	ra,0x1
    51fe:	856080e7          	jalr	-1962(ra) # 5a50 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5240:	d5c78793          	addi	a5,a5,-676 # 7f98 <malloc+0x248a>
    5244:	c0040713          	addi	a4,s0,-1024
    5248:	00003817          	auipc	a6,0x3
    524c:	11080813          	addi	a6,a6,272 # 8358 <malloc+0x284a>
  ...
  printf("usertests starting\n");
    ...
    5270:	ccc50513          	addi	a0,a0,-820 # 7f38 <malloc+0x242a>
    5274:	00000097          	auipc	ra,0x0
    5278:	7dc080e7          	jalr	2012(ra) # 5a50 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    52a8:	c4c50513          	addi	a0,a0,-948 # 7ef0 <malloc+0x23e2>
    52ac:	00000097          	auipc	ra,0x0
    52b0:	7a4080e7          	jalr	1956(ra) # 5a50 <printf>
    exit(1);
    52b4:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    52c4:	bc858593          	addi	a1,a1,-1080 # 7e88 <malloc+0x237a>
    ...
    52da:	c9a58593          	addi	a1,a1,-870 # 7f70 <malloc+0x2462>
    ...
    52fe:	b9650513          	addi	a0,a0,-1130 # 7e90 <malloc+0x2382>
    5302:	00000097          	auipc	ra,0x0
    5306:	74e080e7          	jalr	1870(ra) # 5a50 <printf>
    exit(1);
    530a:	4505                	li	a0,1
    ...
    5328:	72c080e7          	jalr	1836(ra) # 5a50 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    536a:	b7250513          	addi	a0,a0,-1166 # 7ed8 <malloc+0x23ca>
    536e:	00000097          	auipc	ra,0x0
    5372:	6e2080e7          	jalr	1762(ra) # 5a50 <printf>
    exit(1);
    5376:	4505                	li	a0,1
    ...
    5384:	ba050513          	addi	a0,a0,-1120 # 7f20 <malloc+0x2412>
    5388:	00000097          	auipc	ra,0x0
    538c:	6c8080e7          	jalr	1736(ra) # 5a50 <printf>
    exit(0);
    5390:	4501                	li	a0,0
    ...
    53a0:	6b4080e7          	jalr	1716(ra) # 5a50 <printf>
        if(continuous != 2)
    ...
    53e2:	bba78793          	addi	a5,a5,-1094 # 7f98 <malloc+0x248a>
    53e6:	c0040713          	addi	a4,s0,-1024
    53ea:	00003817          	auipc	a6,0x3
    53ee:	f6e80813          	addi	a6,a6,-146 # 8358 <malloc+0x284a>
    ...
    5412:	b4250513          	addi	a0,a0,-1214 # 7f50 <malloc+0x2442>
    5416:	00000097          	auipc	ra,0x0
    541a:	63a080e7          	jalr	1594(ra) # 5a50 <printf>
        printf("SOME TESTS FAILED\n");
    541e:	00003a97          	auipc	s5,0x3
    5422:	abaa8a93          	addi	s5,s5,-1350 # 7ed8 <malloc+0x23ca>
        if(continuous != 2)
    5426:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5428:	00003b17          	auipc	s6,0x3
    542c:	a90b0b13          	addi	s6,s6,-1392 # 7eb8 <malloc+0x23aa>
...
0000000000005758 <kthread_create>:
...
putc(int fd, char c)
{
    5778:	1101                	addi	sp,sp,-32
    577a:	ec06                	sd	ra,24(sp)
    577c:	e822                	sd	s0,16(sp)
    577e:	1000                	addi	s0,sp,32
    5780:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5784:	4605                	li	a2,1
    5786:	fef40593          	addi	a1,s0,-17
    578a:	00000097          	auipc	ra,0x0
    578e:	f36080e7          	jalr	-202(ra) # 56c0 <write>
}
...
{
    579a:	7139                	addi	sp,sp,-64
    579c:	fc06                	sd	ra,56(sp)
    579e:	f822                	sd	s0,48(sp)
    57a0:	f426                	sd	s1,40(sp)
    57a2:	f04a                	sd	s2,32(sp)
    57a4:	ec4e                	sd	s3,24(sp)
    57a6:	0080                	addi	s0,sp,64
    57a8:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    57aa:	c299                	beqz	a3,57b0 <printint+0x16>
    57ac:	0805c863          	bltz	a1,583c <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    57b0:	2581                	sext.w	a1,a1
  neg = 0;
    57b2:	4881                	li	a7,0
    57b4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    57ba:	2601                	sext.w	a2,a2
    57bc:	00003517          	auipc	a0,0x3
    57c0:	ba450513          	addi	a0,a0,-1116 # 8360 <digits>
    57c4:	883a                	mv	a6,a4
    57c6:	2705                	addiw	a4,a4,1
    57c8:	02c5f7bb          	remuw	a5,a1,a2
    57cc:	1782                	slli	a5,a5,0x20
    57ce:	9381                	srli	a5,a5,0x20
    57d0:	97aa                	add	a5,a5,a0
    57d2:	0007c783          	lbu	a5,0(a5)
    57d6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    57da:	0005879b          	sext.w	a5,a1
    57de:	02c5d5bb          	divuw	a1,a1,a2
    57e2:	0685                	addi	a3,a3,1
    57e4:	fec7f0e3          	bgeu	a5,a2,57c4 <printint+0x2a>
  if(neg)
    57e8:	00088b63          	beqz	a7,57fe <printint+0x64>
    buf[i++] = '-';
    57ec:	fd040793          	addi	a5,s0,-48
    57f0:	973e                	add	a4,a4,a5
    57f2:	02d00793          	li	a5,45
    57f6:	fef70823          	sb	a5,-16(a4)
    57fa:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    57fe:	02e05863          	blez	a4,582e <printint+0x94>
    5802:	fc040793          	addi	a5,s0,-64
    5806:	00e78933          	add	s2,a5,a4
    580a:	fff78993          	addi	s3,a5,-1
    580e:	99ba                	add	s3,s3,a4
    5810:	377d                	addiw	a4,a4,-1
    5812:	1702                	slli	a4,a4,0x20
    5814:	9301                	srli	a4,a4,0x20
    5816:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    581a:	fff94583          	lbu	a1,-1(s2)
    581e:	8526                	mv	a0,s1
    5820:	00000097          	auipc	ra,0x0
    5824:	f58080e7          	jalr	-168(ra) # 5778 <putc>
  while(--i >= 0)
    5828:	197d                	addi	s2,s2,-1
    582a:	ff3918e3          	bne	s2,s3,581a <printint+0x80>
}
    582e:	70e2                	ld	ra,56(sp)
    5830:	7442                	ld	s0,48(sp)
    5832:	74a2                	ld	s1,40(sp)
    5834:	7902                	ld	s2,32(sp)
    5836:	69e2                	ld	s3,24(sp)
    5838:	6121                	addi	sp,sp,64
    583a:	8082                	ret
    x = -xx;
    583c:	40b005bb          	negw	a1,a1
    neg = 1;
    5840:	4885                	li	a7,1
    x = -xx;
    5842:	bf8d                	j	57b4 <printint+0x1a>
...
{
    5844:	7119                	addi	sp,sp,-128
    5846:	fc86                	sd	ra,120(sp)
    5848:	f8a2                	sd	s0,112(sp)
    584a:	f4a6                	sd	s1,104(sp)
    584c:	f0ca                	sd	s2,96(sp)
    584e:	ecce                	sd	s3,88(sp)
    5850:	e8d2                	sd	s4,80(sp)
    5852:	e4d6                	sd	s5,72(sp)
    5854:	e0da                	sd	s6,64(sp)
    5856:	fc5e                	sd	s7,56(sp)
    5858:	f862                	sd	s8,48(sp)
    585a:	f466                	sd	s9,40(sp)
    585c:	f06a                	sd	s10,32(sp)
    585e:	ec6e                	sd	s11,24(sp)
    5860:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5862:	0005c903          	lbu	s2,0(a1)
    5866:	18090f63          	beqz	s2,5a04 <vprintf+0x1c0>
    586a:	8aaa                	mv	s5,a0
    586c:	8b32                	mv	s6,a2
    586e:	00158493          	addi	s1,a1,1
  state = 0;
    5872:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5874:	02500a13          	li	s4,37
      if(c == 'd'){
    5878:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    587c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5880:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5884:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5888:	00003b97          	auipc	s7,0x3
    588c:	ad8b8b93          	addi	s7,s7,-1320 # 8360 <digits>
    5890:	a839                	j	58ae <vprintf+0x6a>
        putc(fd, c);
    5892:	85ca                	mv	a1,s2
    5894:	8556                	mv	a0,s5
    5896:	00000097          	auipc	ra,0x0
    589a:	ee2080e7          	jalr	-286(ra) # 5778 <putc>
    589e:	a019                	j	58a4 <vprintf+0x60>
    } else if(state == '%'){
    58a0:	01498f63          	beq	s3,s4,58be <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    58a4:	0485                	addi	s1,s1,1
    58a6:	fff4c903          	lbu	s2,-1(s1)
    58aa:	14090d63          	beqz	s2,5a04 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    58ae:	0009079b          	sext.w	a5,s2
    if(state == 0){
    58b2:	fe0997e3          	bnez	s3,58a0 <vprintf+0x5c>
      if(c == '%'){
    58b6:	fd479ee3          	bne	a5,s4,5892 <vprintf+0x4e>
        state = '%';
    58ba:	89be                	mv	s3,a5
    58bc:	b7e5                	j	58a4 <vprintf+0x60>
      if(c == 'd'){
    58be:	05878063          	beq	a5,s8,58fe <vprintf+0xba>
      } else if(c == 'l') {
    58c2:	05978c63          	beq	a5,s9,591a <vprintf+0xd6>
      } else if(c == 'x') {
    58c6:	07a78863          	beq	a5,s10,5936 <vprintf+0xf2>
      } else if(c == 'p') {
    58ca:	09b78463          	beq	a5,s11,5952 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    58ce:	07300713          	li	a4,115
    58d2:	0ce78663          	beq	a5,a4,599e <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    58d6:	06300713          	li	a4,99
    58da:	0ee78e63          	beq	a5,a4,59d6 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    58de:	11478863          	beq	a5,s4,59ee <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    58ea:	e92080e7          	jalr	-366(ra) # 5778 <putc>
        putc(fd, c);
    58ee:	85ca                	mv	a1,s2
    58f0:	8556                	mv	a0,s5
    58f2:	00000097          	auipc	ra,0x0
    58f6:	e86080e7          	jalr	-378(ra) # 5778 <putc>
      }
      state = 0;
    58fa:	4981                	li	s3,0
    58fc:	b765                	j	58a4 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5910:	e8e080e7          	jalr	-370(ra) # 579a <printint>
    5914:	8b4a                	mv	s6,s2
      state = 0;
    5916:	4981                	li	s3,0
    5918:	b771                	j	58a4 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    591a:	008b0913          	addi	s2,s6,8
    591e:	4681                	li	a3,0
    5920:	4629                	li	a2,10
    5922:	000b2583          	lw	a1,0(s6)
    5926:	8556                	mv	a0,s5
    5928:	00000097          	auipc	ra,0x0
    592c:	e72080e7          	jalr	-398(ra) # 579a <printint>
    5930:	8b4a                	mv	s6,s2
      state = 0;
    5932:	4981                	li	s3,0
    5934:	bf85                	j	58a4 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5936:	008b0913          	addi	s2,s6,8
    593a:	4681                	li	a3,0
    593c:	4641                	li	a2,16
    593e:	000b2583          	lw	a1,0(s6)
    5942:	8556                	mv	a0,s5
    5944:	00000097          	auipc	ra,0x0
    5948:	e56080e7          	jalr	-426(ra) # 579a <printint>
    594c:	8b4a                	mv	s6,s2
      state = 0;
    594e:	4981                	li	s3,0
    5950:	bf91                	j	58a4 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5952:	008b0793          	addi	a5,s6,8
    5956:	f8f43423          	sd	a5,-120(s0)
    595a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    595e:	03000593          	li	a1,48
    5962:	8556                	mv	a0,s5
    5964:	00000097          	auipc	ra,0x0
    5968:	e14080e7          	jalr	-492(ra) # 5778 <putc>
  putc(fd, 'x');
    596c:	85ea                	mv	a1,s10
    596e:	8556                	mv	a0,s5
    5970:	00000097          	auipc	ra,0x0
    5974:	e08080e7          	jalr	-504(ra) # 5778 <putc>
    5978:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    597a:	03c9d793          	srli	a5,s3,0x3c
    597e:	97de                	add	a5,a5,s7
    5980:	0007c583          	lbu	a1,0(a5)
    5984:	8556                	mv	a0,s5
    5986:	00000097          	auipc	ra,0x0
    598a:	df2080e7          	jalr	-526(ra) # 5778 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    598e:	0992                	slli	s3,s3,0x4
    5990:	397d                	addiw	s2,s2,-1
    5992:	fe0914e3          	bnez	s2,597a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5996:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    599a:	4981                	li	s3,0
    599c:	b721                	j	58a4 <vprintf+0x60>
        s = va_arg(ap, char*);
    599e:	008b0993          	addi	s3,s6,8
    59a2:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    59a6:	02090163          	beqz	s2,59c8 <vprintf+0x184>
        while(*s != 0){
    59aa:	00094583          	lbu	a1,0(s2)
    59ae:	c9a1                	beqz	a1,59fe <vprintf+0x1ba>
          putc(fd, *s);
    59b0:	8556                	mv	a0,s5
    59b2:	00000097          	auipc	ra,0x0
    59b6:	dc6080e7          	jalr	-570(ra) # 5778 <putc>
          s++;
    59ba:	0905                	addi	s2,s2,1
        while(*s != 0){
    59bc:	00094583          	lbu	a1,0(s2)
    59c0:	f9e5                	bnez	a1,59b0 <vprintf+0x16c>
        s = va_arg(ap, char*);
    59c2:	8b4e                	mv	s6,s3
      state = 0;
    59c4:	4981                	li	s3,0
    59c6:	bdf9                	j	58a4 <vprintf+0x60>
          s = "(null)";
    59c8:	00003917          	auipc	s2,0x3
    59cc:	99090913          	addi	s2,s2,-1648 # 8358 <malloc+0x284a>
        while(*s != 0){
    59d0:	02800593          	li	a1,40
    59d4:	bff1                	j	59b0 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    59d6:	008b0913          	addi	s2,s6,8
    59da:	000b4583          	lbu	a1,0(s6)
    59de:	8556                	mv	a0,s5
    59e0:	00000097          	auipc	ra,0x0
    59e4:	d98080e7          	jalr	-616(ra) # 5778 <putc>
    59e8:	8b4a                	mv	s6,s2
      state = 0;
    59ea:	4981                	li	s3,0
    59ec:	bd65                	j	58a4 <vprintf+0x60>
        putc(fd, c);
    59ee:	85d2                	mv	a1,s4
    59f0:	8556                	mv	a0,s5
    59f2:	00000097          	auipc	ra,0x0
    59f6:	d86080e7          	jalr	-634(ra) # 5778 <putc>
      state = 0;
    59fa:	4981                	li	s3,0
    59fc:	b565                	j	58a4 <vprintf+0x60>
        s = va_arg(ap, char*);
    59fe:	8b4e                	mv	s6,s3
      state = 0;
    5a00:	4981                	li	s3,0
    5a02:	b54d                	j	58a4 <vprintf+0x60>
    }
  }
}
    5a04:	70e6                	ld	ra,120(sp)
    5a06:	7446                	ld	s0,112(sp)
    5a08:	74a6                	ld	s1,104(sp)
    5a0a:	7906                	ld	s2,96(sp)
    5a0c:	69e6                	ld	s3,88(sp)
    5a0e:	6a46                	ld	s4,80(sp)
    5a10:	6aa6                	ld	s5,72(sp)
    5a12:	6b06                	ld	s6,64(sp)
    5a14:	7be2                	ld	s7,56(sp)
    5a16:	7c42                	ld	s8,48(sp)
    5a18:	7ca2                	ld	s9,40(sp)
    5a1a:	7d02                	ld	s10,32(sp)
    5a1c:	6de2                	ld	s11,24(sp)
    5a1e:	6109                	addi	sp,sp,128
    5a20:	8082                	ret

0000000000005a22 <fprintf>:
...
fprintf(int fd, const char *fmt, ...)
{
    ...
    5a2a:	e010                	sd	a2,0(s0)
    5a2c:	e414                	sd	a3,8(s0)
    5a2e:	e818                	sd	a4,16(s0)
    5a30:	ec1c                	sd	a5,24(s0)
    5a32:	03043023          	sd	a6,32(s0)
    5a36:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5a3a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5a3e:	8622                	mv	a2,s0
    5a40:	00000097          	auipc	ra,0x0
    5a44:	e04080e7          	jalr	-508(ra) # 5844 <vprintf>
}
    5a48:	60e2                	ld	ra,24(sp)
    5a4a:	6442                	ld	s0,16(sp)
    5a4c:	6161                	addi	sp,sp,80
    5a4e:	8082                	ret

0000000000005a50 <printf>:
...
printf(const char *fmt, ...)
{
    ...
    5a58:	e40c                	sd	a1,8(s0)
    5a5a:	e810                	sd	a2,16(s0)
    5a5c:	ec14                	sd	a3,24(s0)
    5a5e:	f018                	sd	a4,32(s0)
    5a60:	f41c                	sd	a5,40(s0)
    5a62:	03043823          	sd	a6,48(s0)
    5a66:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5a6a:	00840613          	addi	a2,s0,8
    5a6e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5a72:	85aa                	mv	a1,a0
    5a74:	4505                	li	a0,1
    5a76:	00000097          	auipc	ra,0x0
    5a7a:	dce080e7          	jalr	-562(ra) # 5844 <vprintf>
}
    5a7e:	60e2                	ld	ra,24(sp)
    5a80:	6442                	ld	s0,16(sp)
    5a82:	6125                	addi	sp,sp,96
    5a84:	8082                	ret

0000000000005a86 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    5a8c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5a90:	00003797          	auipc	a5,0x3
    5a94:	8f87b783          	ld	a5,-1800(a5) # 8388 <freep>
    5a98:	a805                	j	5ac8 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5a9a:	4618                	lw	a4,8(a2)
    5a9c:	9db9                	addw	a1,a1,a4
    5a9e:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5aa2:	6398                	ld	a4,0(a5)
    5aa4:	6318                	ld	a4,0(a4)
    5aa6:	fee53823          	sd	a4,-16(a0)
    5aaa:	a091                	j	5aee <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5aac:	ff852703          	lw	a4,-8(a0)
    5ab0:	9e39                	addw	a2,a2,a4
    5ab2:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5ab4:	ff053703          	ld	a4,-16(a0)
    5ab8:	e398                	sd	a4,0(a5)
    5aba:	a099                	j	5b00 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5abc:	6398                	ld	a4,0(a5)
    5abe:	00e7e463          	bltu	a5,a4,5ac6 <free+0x40>
    5ac2:	00e6ea63          	bltu	a3,a4,5ad6 <free+0x50>
{
    5ac6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5ac8:	fed7fae3          	bgeu	a5,a3,5abc <free+0x36>
    5acc:	6398                	ld	a4,0(a5)
    5ace:	00e6e463          	bltu	a3,a4,5ad6 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5ad2:	fee7eae3          	bltu	a5,a4,5ac6 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5ad6:	ff852583          	lw	a1,-8(a0)
    5ada:	6390                	ld	a2,0(a5)
    5adc:	02059813          	slli	a6,a1,0x20
    5ae0:	01c85713          	srli	a4,a6,0x1c
    5ae4:	9736                	add	a4,a4,a3
    5ae6:	fae60ae3          	beq	a2,a4,5a9a <free+0x14>
    bp->s.ptr = p->s.ptr;
    5aea:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5aee:	4790                	lw	a2,8(a5)
    5af0:	02061593          	slli	a1,a2,0x20
    5af4:	01c5d713          	srli	a4,a1,0x1c
    5af8:	973e                	add	a4,a4,a5
    5afa:	fae689e3          	beq	a3,a4,5aac <free+0x26>
  } else
    p->s.ptr = bp;
    5afe:	e394                	sd	a3,0(a5)
  freep = p;
    5b00:	00003717          	auipc	a4,0x3
    5b04:	88f73423          	sd	a5,-1912(a4) # 8388 <freep>
}
    5b08:	6422                	ld	s0,8(sp)
    5b0a:	0141                	addi	sp,sp,16
    5b0c:	8082                	ret

0000000000005b0e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5b0e:	7139                	addi	sp,sp,-64
    5b10:	fc06                	sd	ra,56(sp)
    5b12:	f822                	sd	s0,48(sp)
    5b14:	f426                	sd	s1,40(sp)
    5b16:	f04a                	sd	s2,32(sp)
    5b18:	ec4e                	sd	s3,24(sp)
    5b1a:	e852                	sd	s4,16(sp)
    5b1c:	e456                	sd	s5,8(sp)
    5b1e:	e05a                	sd	s6,0(sp)
    5b20:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5b22:	02051493          	slli	s1,a0,0x20
    5b26:	9081                	srli	s1,s1,0x20
    5b28:	04bd                	addi	s1,s1,15
    5b2a:	8091                	srli	s1,s1,0x4
    5b2c:	0014899b          	addiw	s3,s1,1
    5b30:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5b32:	00003517          	auipc	a0,0x3
    5b36:	85653503          	ld	a0,-1962(a0) # 8388 <freep>
    5b3a:	c515                	beqz	a0,5b66 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5b3c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5b3e:	4798                	lw	a4,8(a5)
    5b40:	02977f63          	bgeu	a4,s1,5b7e <malloc+0x70>
    5b44:	8a4e                	mv	s4,s3
    5b46:	0009871b          	sext.w	a4,s3
    5b4a:	6685                	lui	a3,0x1
    5b4c:	00d77363          	bgeu	a4,a3,5b52 <malloc+0x44>
    5b50:	6a05                	lui	s4,0x1
    5b52:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5b56:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    5b5e:	82e90913          	addi	s2,s2,-2002 # 8388 <freep>
  if(p == (char*)-1)
    5b62:	5afd                	li	s5,-1
    5b64:	a895                	j	5bd8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5b66:	00009797          	auipc	a5,0x9
    5b6a:	04278793          	addi	a5,a5,66 # eba8 <base>
    5b6e:	00003717          	auipc	a4,0x3
    5b72:	80f73d23          	sd	a5,-2022(a4) # 8388 <freep>
    5b76:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5b78:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5b7c:	b7e1                	j	5b44 <malloc+0x36>
      if(p->s.size == nunits)
    5b7e:	02e48c63          	beq	s1,a4,5bb6 <malloc+0xa8>
        p->s.size -= nunits;
    5b82:	4137073b          	subw	a4,a4,s3
    5b86:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5b88:	02071693          	slli	a3,a4,0x20
    5b8c:	01c6d713          	srli	a4,a3,0x1c
    5b90:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5b92:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5b96:	00002717          	auipc	a4,0x2
    5b9a:	7ea73923          	sd	a0,2034(a4) # 8388 <freep>
      return (void*)(p + 1);
    5b9e:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5ba2:	70e2                	ld	ra,56(sp)
    5ba4:	7442                	ld	s0,48(sp)
    5ba6:	74a2                	ld	s1,40(sp)
    5ba8:	7902                	ld	s2,32(sp)
    5baa:	69e2                	ld	s3,24(sp)
    5bac:	6a42                	ld	s4,16(sp)
    5bae:	6aa2                	ld	s5,8(sp)
    5bb0:	6b02                	ld	s6,0(sp)
    5bb2:	6121                	addi	sp,sp,64
    5bb4:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5bb6:	6398                	ld	a4,0(a5)
    5bb8:	e118                	sd	a4,0(a0)
    5bba:	bff1                	j	5b96 <malloc+0x88>
  hp->s.size = nu;
    5bbc:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5bc0:	0541                	addi	a0,a0,16
    5bc2:	00000097          	auipc	ra,0x0
    5bc6:	ec4080e7          	jalr	-316(ra) # 5a86 <free>
  return freep;
    5bca:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5bce:	d971                	beqz	a0,5ba2 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5bd0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5bd2:	4798                	lw	a4,8(a5)
    5bd4:	fa9775e3          	bgeu	a4,s1,5b7e <malloc+0x70>
    if(p == freep)
    5bd8:	00093703          	ld	a4,0(s2)
    5bdc:	853e                	mv	a0,a5
    5bde:	fef719e3          	bne	a4,a5,5bd0 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5be2:	8552                	mv	a0,s4
    5be4:	00000097          	auipc	ra,0x0
    5be8:	b44080e7          	jalr	-1212(ra) # 5728 <sbrk>
  if(p == (char*)-1)
    5bec:	fd5518e3          	bne	a0,s5,5bbc <malloc+0xae>
        return 0;
    5bf0:	4501                	li	a0,0
    5bf2:	bf45                	j	5ba2 <malloc+0x94>
